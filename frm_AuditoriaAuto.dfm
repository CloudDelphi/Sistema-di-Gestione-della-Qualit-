object FormAuditoriaAuto: TFormAuditoriaAuto
  Left = 0
  Top = 0
  ...
  object pnlEsquerda: TPanel
    ...
    object dbgAuditorias: TDBGrid
      ...
      TitleFont.Style = []
      OnCellClick = dbgAuditoriasCellClick
      Columns = <
        item
          Expanded = False
          FieldName = 'aud_data'
          Title.Caption = 'Auditorias Gravadas'
  ...
  object pnl1: TPanel
    ...
    object btnGerarAuditoria: TBitBtn
      Left = 1
      Top = 1
      Width = 73
      Height = 70
    ...
    object btnGravar: TBitBtn
      ...
      Width = 73
      Height = 70
      Hint = 'Clique para gravar o relat'#243'rio'
      Align = alLeft
      Caption = '&Gravar'
      DoubleBuffered = True
      Font.Charset = DEFAULT_CHARSET
    ...
    object btnEvidencias: TBitBtn
      ...
      Width = 122
      Height = 70
      Hint = 'Clique para cadastrar as evid'#234'ncias manualmente'
      Align = alLeft
      Caption = '&Evid'#234'ncias Manuais'
      DoubleBuffered = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
  ...
  object pnlEvidencias: TPanel
    ...
    object pnl2: TPanel
      ...
      object btnSairEvid: TBitBtn
        ...
        ShowHint = True
        TabOrder = 0
        OnClick = btnSairEvidClick
      end
      object btnGravarEvid: TBitBtn
        Left = 1
        Top = 1
        Width = 73
        Height = 70
        Hint = 'Clique para gravar a evid'#234'ncia'
        Align = alLeft
        Caption = '&Gravar'
        DoubleBuffered = True
        Font.Charset = DEFAULT_CHARSET
    ...
    object pnlTitulo: TPanel
      ...
      Caption = ' Cadastro de Evid'#234'ncias'
  ...
  object cdsAuditoria: TClientDataSet
    ...
    Left = 296
    Top = 248
    object cdsAuditoriaaud_data: TDateTimeField
      FieldName = 'aud_data'
    end
    object cdsAuditoriaaud_conformidade: TWideMemoField
      FieldName = 'aud_conformidade'
      BlobType = ftWideMemo
    end
    object cdsAuditoriaaud_requisito: TStringField
      FieldName = 'aud_requisito'
      Size = 10
    end
    object cdsAuditoriaaud_naoconformidade: TWideMemoField
      FieldName = 'aud_naoconformidade'
      BlobType = ftWideMemo
    end
    object cdsAuditoriaaud_tipo: TWideStringField
      FieldName = 'aud_tipo'
      Size = 30
    end
    object cdsAuditoriaaud_processo: TIntegerField
      FieldName = 'aud_processo'
    end
    object cdsAuditoriaaud_gestor: TIntegerField
      FieldName = 'aud_gestor'
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43126.716361365740000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSCabec
        DataSetName = 'frxDBDSCabec'
      end
      item
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo3: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            'Escopo: [frxDBDSCabec."emp_escopo"]')
          ParentFont = False
        end
        object Memo13: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            'Auditor: [frxDBDSCabec."aud_auditor"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo14: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Per'#237'odo da Auditoria: [<frxDBDSCabec."aud_periodo_ini">] a [<frx' +
              'DBDSCabec."aud_periodo_fim">]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo15: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Data do Programa de Auditoria: [frxDBDSCabec."aud_data_programa"' +
              ']')
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  object zqryGravadas: TZQuery
    Connection = dm.Conexao
    Params = <>
    Left = 216
    Top = 200
  end
  object dspGravadas: TDataSetProvider
    DataSet = zqryGravadas
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 256
    Top = 200
  end
  object cdsGravadas: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspGravadas'
    Left = 296
    Top = 200
  end
  object dsGravadas: TDataSource
    DataSet = cdsGravadas
    Left = 336
    Top = 200
  end
  object frxDBAuditoriaAuto: TfrxDBDataset
    UserName = 'frxDBAuditoriaAuto'
    CloseDataSource = False
    FieldAliases.Strings = (
      'aud_codigo=aud_codigo'
      'aud_data=aud_data'
      'aud_conformidade=aud_conformidade'
      'aud_requisito=aud_requisito'
      'aud_naoconformidade=aud_naoconformidade'
      'aud_tipo=aud_tipo'
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 773
    Top = 120
    object cdsImprimiraud_codigo: TIntegerField
      FieldName = 'aud_codigo'
      Required = True
    end
    object cdsImprimiraud_data: TDateTimeField
      FieldName = 'aud_data'
      Required = True
    end
    object cdsImprimiraud_conformidade: TWideMemoField
      FieldName = 'aud_conformidade'
      BlobType = ftWideMemo
    end
    object cdsImprimiraud_requisito: TWideStringField
      FieldName = 'aud_requisito'
      ReadOnly = True
      Size = 10
    end
    object cdsImprimiraud_naoconformidade: TWideMemoField
      FieldName = 'aud_naoconformidade'
      BlobType = ftWideMemo
    end
    object cdsImprimiraud_tipo: TWideStringField
      FieldName = 'aud_tipo'
      Size = 30
    end
    object cdsImprimiraud_processo: TIntegerField
      FieldName = 'aud_processo'
    end
    object cdsImprimiraud_gestor: TIntegerField
      FieldName = 'aud_gestor'
    end
    ...
    object cdsImprimirgestor: TWideStringField
      FieldName = 'gestor'
      ReadOnly = True
      Size = 45
    end
    object cdsImprimirfuncaogestor: TWideStringField
      FieldName = 'funcaogestor'
      ReadOnly = True
      Size = 50
    end
  ...
  object frxDBDSSemGravar: TfrxDBDataset
    UserName = 'frxDBDSSemGravar'
    CloseDataSource = False
    FieldAliases.Strings = (
      'aud_data=aud_data'
      'aud_conformidade=aud_conformidade'
