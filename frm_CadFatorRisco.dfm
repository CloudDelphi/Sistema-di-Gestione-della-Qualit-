object FormCadFatorRiscoExt: TFormCadFatorRiscoExt
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Fatores de Risco Externos'
  ClientHeight = 398
  ClientWidth = 527
  Color = clBtnFace
  ...
  object pctTreinamentos: TJvgPageControl
    ...
    object tsPesquisa: TTabSheet
      ...
      object dbgFatores: TDBGrid
        ...
        TitleFont.Style = []
        OnCellClick = dbgFatoresCellClick
        OnDblClick = dbgFatoresDblClick
        Columns = <
          item
            Expanded = False
            FieldName = 'codi_com'
