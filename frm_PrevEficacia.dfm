object FormPrevEficacia: TFormPrevEficacia
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsDialog
  Caption = 'Previs'#227'o de Checagem'
  ClientHeight = 158
  ClientWidth = 265
  Color = clBtnFace
  ...
  object lbl35: TLabel
    ...
    Width = 79
    Height = 13
    Caption = 'Prev. Checagem'
  end
  object dtVerEfic: TDateEdit
    Tag = 30
    Left = 16
    Top = 27
    Width = 105
  ...
  object pnl15: TPanel
    ...
    object btnGravarVerEfic: TBitBtn
      ...
      Width = 73
      Height = 70
      Hint = 'Clique para gravar a data prevista da Verifica'#231#227'o de Efic'#225'cia'
      Align = alLeft
      Caption = '&Gravar'
      DoubleBuffered = True
      Font.Charset = DEFAULT_CHARSET
