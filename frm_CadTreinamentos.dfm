object FormCadTreinamentos: TFormCadTreinamentos
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Treinamentos'
  ClientHeight = 469
  ClientWidth = 528
  Color = clBtnFace
  ...
  object pctTreinamentos: TJvgPageControl
    ...
    object tsCadastro: TTabSheet
      ...
      object lbl16: TLabel
        ...
        Width = 113
        Height = 13
        Caption = 'Conte'#250'do Program'#225'tico'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object mmoConteudo: TMemo
        ...
        TabOrder = 2
        OnExit = mmoConteudoExit
        OnKeyPress = mmoConteudoKeyPress
      end
      ...
      object dbgTreinamentos: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'desc_tre'
            Title.Caption = 'Nome do Treinamento'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object pnlImprimir: TPanel
    ...
    object grp1: TGroupBox
      ...
      object chkConteudo: TCheckBox
        ...
        Width = 217
        Height = 17
        Caption = 'Imprimir Conte'#250'do Program'#225'tico'
        TabOrder = 0
      end
    end
  end
  ...
  object frxDBDSTreinamentos: TfrxDBDataset
    UserName = 'frxDBDSTreinamentos'
    CloseDataSource = False
    FieldAliases.Strings = (
      'codi_tre=codi_tre'
      'desc_tre=desc_tre'
      'tre_conteudo=tre_conteudo'
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT codi_tre, desc_tre, tre_conteudo, tre_status, TC.valo_com' +
        ' as Status'
      'FROM treinamentos'
      
        'INNER JOIN tabela_combos TC ON TC.tipo_com = 15  AND TC.codi_com' +
        ' = tre_status')
    Params = <>
    Left = 360
    Top = 216
  ...
  object cdsImprimir: TClientDataSet
    ...
    object cdsImprimirtre_conteudo: TWideMemoField
      FieldName = 'tre_conteudo'
      BlobType = ftWideMemo
    end
    object cdsImprimirtre_status: TIntegerField
      FieldName = 'tre_status'
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42859.656398020830000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSTreinamentos
        DataSetName = 'frxDBDSTreinamentos'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Detalhe: TfrxMasterData
        ...
        object frxControleDATA: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSTreinamentos."codi_tre"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo10: TfrxMemoView
          Left = 102.771653540000000000
          Width = 510.236493860000000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'desc_tre'
          DataSet = frxDBDSTreinamentos
