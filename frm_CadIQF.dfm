object FormCadIQF: TFormCadIQF
  ...
  object pnlImprimir: TPanel
    ...
    object pnl4: TPanel
      ...
      object spnQtdeMeses: TRxSpinEdit
        Tag = 30
        Left = 172
        Top = -1
        Width = 73
        Height = 26
        Increment = 6.000000000000000000
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
      ...
      '                          CASE '
        ...
        '                             WHEN F.forn_tipoProd IS NULL THEN '#39 +
        'SEM CLASSIFICA'#199#195'O'#39
      
        '                             WHEN F.forn_tipoProd <= 0 THEN '#39'SEM' +
        ' CLASSIFICA'#199#195'O'#39
      '                             ELSE P.tipo_nomeTipo'
      '                          END as tipo_nomeTipo,'
      '                          iqf_codFornecedor, COUNT(*) as Qtd, '
      '                          AVG('
      
        '                          (SELECT for_avaliacao FROM forn_avalia' +
        'cao'
      
        '                           WHERE (for_data_validade BETWEEN I.iq' +
        'f_data AND for_data_validade) AND for_codfor = F.forn_codigo'
      
        '                           ORDER BY for_data_validade LIMIT 1) *' +
        '  0.2 +'
      
        '                          (iqf_pontual * 30) + (iqf_conforme * 5' +
        '0)) as IQF'
      '                          FROM iqf_remessa I'
      
        '                          INNER JOIN Fornecedores F ON F.forn_co' +
        'digo = iqf_codFornecedor'
      
        '                          LEFT JOIN forn_tipo_produto P ON P.tip' +
        'o_codigo = F.forn_tipoProd'
      'GROUP BY iqf_codFornecedor, F.forn_nome, F.forn_avaliacao, '
  ...
  object cdsImprimir: TClientDataSet
    ...
    object cdsImprimirforn_area: TWideMemoField
      FieldName = 'forn_area'
      ReadOnly = True
      BlobType = ftWideMemo
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43558.653051377320000000
    ...
    object Page1: TfrxReportPage
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo22: TfrxMemoView
          Left = 338.779840000000000000
          Width = 231.307084170000000000
          Height = 37.795300000000000000
          ShowHint = False
        ...
        object Memo24: TfrxMemoView
          Left = 570.370440000000000000
          Width = 73.700784960000000000
          Height = 37.795300000000000000
          ShowHint = False
          DataField = 'avaliacao'
          DataSet = frxDBImpRelacao
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBImpRelacao."avaliacao"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo29: TfrxMemoView
          Width = 52.535389130000000000
          Height = 37.795300000000000000
          ShowHint = False
          DataField = 'iqf_codigo'
          DataSet = frxDBImpRelacao
          DataSetName = 'frxDBImpRelacao'
          DisplayFormat.DecimalSeparator = ','
          DisplayFormat.FormatStr = '%2.2f'
      ...
      object GroupFooter1: TfrxGroupFooter
        ...
        object Memo33: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[AVG(<frxDBImpRelacao."IQF">,Detalhe) - <frxDBImpRelacao."demeri' +
              'to">]'
            '')
          ParentFont = False
          VAlign = vaCenter
  ...
  object zqryImpRelacao: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT I.iqf_codigo, F.forn_nome, I.iqf_data, I.iqf_CodFornecedo' +
        'r, I.iqf_pontual, '
      
        'I.iqf_conforme, I.iqf_NF, iqf_responsavel, TC.valo_com as Pontua' +
        'l, '
      'TC1.valo_com as Conforme, C.nome_col as Responsavel, '
      '(SELECT for_avaliacao FROM forn_avaliacao '
      
        ' WHERE (for_data_validade BETWEEN i.iqf_data AND for_data_valida' +
        'de) AND for_codfor = F.forn_codigo'
      ' ORDER BY for_data_validade LIMIT 1) as Avaliacao,'
      '((SELECT for_avaliacao FROM forn_avaliacao '
      
        'WHERE (for_data_validade BETWEEN i.iqf_data AND for_data_validad' +
        'e) AND for_codfor = F.forn_codigo'
      
        'ORDER BY for_data_validade LIMIT 1) * 0.2) + (iqf_pontual * 30) ' +
        '+ (iqf_conforme * 50) as IQF,'
      'F.forn_tipoProd, I.iqf_obs, '
      'CASE '
      '   WHEN F.forn_tipoProd IS NULL THEN '#39'SEM CLASSIFICA'#199#195'O'#39
      '   WHEN F.forn_tipoProd <= 0 THEN '#39'SEM CLASSIFICA'#199#195'O'#39
      '   ELSE P.tipo_nomeTipo'
      'END as tipo_nomeTipo,'
      '(SELECT SUM(dem_nota_demerito) as SomaDemerito '
      #9'FROM iqf_demerito'
      #9'INNER JOIN iqf_remessa I ON I.iqf_codigo = dem_cod_iqf'
      
        #9'INNER JOIN fornecedores F ON F.forn_codigo = I.iqf_codfornecedo' +
        'r'
      #9'WHERE dem_data between '#39'2019-03-01'#39' and '#39'2019-03-31'#39' AND'
      'I.iqf_codfornecedor = F.forn_codigo) as Demerito'
      'FROM iqf_remessa I'
      ...
      'WHERE iqf_data BETWEEN '#39'2017-01-01'#39' AND '#39'2018-12-31'#39
      ' AND iqf_apoio <> 1')
    Params = <>
    Left = 488
    Top = 248
  ...
  object cdsImpRelacao: TClientDataSet
    ...
    Left = 568
    Top = 248
    object cdsImpRelacaoiqf_codigo: TLargeintField
    ...
    object cdsImpRelacaoavaliacao: TFloatField
      FieldName = 'avaliacao'
      ReadOnly = True
    end
    object cdsImpRelacaodemerito: TFloatField
      FieldName = 'demerito'
      ReadOnly = True
    end
  end
  ...
  object zqryRelIndiceMensal: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT F.forn_nome, F.forn_codigo,'
      '(SELECT AVG('
      '((SELECT for_avaliacao FROM forn_avaliacao'
      
        'WHERE (for_data_validade BETWEEN I.iqf_data AND for_data_validad' +
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf1'
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-06-01'#39' AND '#39'2018-06-30'#39
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf2'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-07-01'#39' AND '#39'2018-07-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      'GROUP BY iqf_codfornecedor'
      '),'
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf3'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-08-01'#39' AND '#39'2018-08-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      'GROUP BY iqf_codfornecedor'
      '),'
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf4'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-08-01'#39' AND '#39'2018-08-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf5'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-08-01'#39' AND '#39'2018-08-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf6'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-08-01'#39' AND '#39'2018-08-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf7'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-08-01'#39' AND '#39'2018-08-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf8'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-08-01'#39' AND '#39'2018-08-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf9'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-08-01'#39' AND '#39'2018-08-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf10'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-08-01'#39' AND '#39'2018-08-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf11'
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-08-01'#39' AND '#39'2018-08-31'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      ...
      '((SELECT for_avaliacao FROM forn_avaliacao'
        ...
        'e) AND for_codfor = iqf_codfornecedor'
      'ORDER BY for_data_validade LIMIT 1) * 0.2) +'
      '(iqf_pontual * 30) + (iqf_conforme * 50)) as iqf12'#9
      'FROM iqf_remessa I'
      'WHERE iqf_data BETWEEN '#39'2018-09-01'#39' AND '#39'2018-09-30'#39
      'AND iqf_codfornecedor = F.forn_codigo'
      'AND iqf_apoio <> 1 '
      'GROUP BY iqf_codfornecedor'
      ')'
  ...
  object dspRelIndiceMensal: TDataSetProvider
    DataSet = zqryRelIndiceMensal
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 528
    Top = 296
  end
  object cdsRelIndiceMensal: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspRelIndiceMensal'
    Left = 568
    Top = 296
    object cdsRelIndiceMensalforn_nome: TWideStringField
      FieldName = 'forn_nome'
      ReadOnly = True
      Size = 80
    end
    object cdsRelIndiceMensalforn_codigo: TIntegerField
      FieldName = 'forn_codigo'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf1: TFloatField
      FieldName = 'iqf1'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf2: TFloatField
      FieldName = 'iqf2'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf3: TFloatField
      FieldName = 'iqf3'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf4: TFloatField
      FieldName = 'iqf4'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf5: TFloatField
      FieldName = 'iqf5'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf6: TFloatField
      FieldName = 'iqf6'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf7: TFloatField
      FieldName = 'iqf7'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf8: TFloatField
      FieldName = 'iqf8'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf9: TFloatField
      FieldName = 'iqf9'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf10: TFloatField
      FieldName = 'iqf10'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf11: TFloatField
      FieldName = 'iqf11'
      ReadOnly = True
    end
    object cdsRelIndiceMensaliqf12: TFloatField
      FieldName = 'iqf12'
      ReadOnly = True
    end
  end
  object frxDBRelIndiceMensal: TfrxDBDataset
    UserName = 'frxDBRelIndiceMensal'
    CloseDataSource = False
    FieldAliases.Strings = (
      'forn_nome=forn_nome'
      ...
      'iqf11=iqf11'
      'iqf12=iqf12')
    DataSet = cdsRelIndiceMensal
    BCDToCurrency = False
    Left = 608
    Top = 296
  end
  object zqryIQFDemerito: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      '')
    Params = <>
  ...
  object dspIQFDemerito: TDataSetProvider
    DataSet = zqryIQFDemerito
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 352
    Top = 192
  end
  object cdsIQFDemerito: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspIQFDemerito'
    Left = 392
    Top = 192
  end
  object dsIQFDemerito: TDataSource
    DataSet = cdsIQFDemerito
    Left = 432
    Top = 192
  end
end
