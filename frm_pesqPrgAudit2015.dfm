object FormPesqPrgAudit2015: TFormPesqPrgAudit2015
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Pesquisa de Programa de Auditoria - ISO 9001:2015'
  ClientHeight = 359
  ClientWidth = 337
  Color = clBtnFace
  ...
  object dbgAuditoria: TDBGrid
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'data_aud'
        Title.Caption = 'Data do Programa'
  ...
  object zqryAudInterna: TZQuery
    ...
    SQL.Strings = (
      'select data_aud from auditoria_interna')
    Params = <>
    Left = 64
    Top = 126
  end
