object t_PlanoAcaoMatriz: Tt_PlanoAcaoMatriz
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Verifica'#231#227'o de Efic'#225'cia'
  ClientHeight = 356
  ClientWidth = 633
  Color = clBtnFace
  ...
  object mmoVerif_eficacia: TMemo
    Left = 16
    Top = 178
    Width = 295
    Height = 101
  ...
  object pnlNomeColaborador: TPanel
    Left = 0
    Top = 0
    Width = 633
    Height = 33
  ...
  object cdsEficaz: TClientDataSet
    ...
    Left = 512
    Top = 184
    object cdsEficazcodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    object cdsEficazvalo_com: TWideStringField
      FieldName = 'valo_com'
      Size = 50
    end
  end
  ...
  object cdsPlanoAcao: TClientDataSet
    ...
    object cdsPlanoAcaoacao_pla: TWideMemoField
      FieldName = 'acao_pla'
      BlobType = ftWideMemo
    end
    ...
    object cdsPlanoAcaocome_pla: TWideMemoField
      FieldName = 'come_pla'
      BlobType = ftWideMemo
    end
