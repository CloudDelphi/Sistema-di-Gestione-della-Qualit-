object FormCadAnaliseCritica: TFormCadAnaliseCritica
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctAnalise: TJvgPageControl
    Left = 0
    Top = 0
    Width = 750
    Height = 621
    ...
    object tsCadastro: TTabSheet
      ...
      object dbgEntradas: TDBGrid
        ...
        TitleFont.Style = []
        OnCellClick = dbgEntradasCellClick
        OnDblClick = dbgEntradasDblClick
        OnKeyUp = dbgAcoesPMCKeyUp
        Columns = <
          item
            Expanded = False
            FieldName = 'Entrada'
      ...
      object pnlImprimir: TPanel
        ...
        object dblProcessosImp: TDBLookupComboBox
          Left = 10
          Top = 47
          Width = 240
          Height = 26
        ...
        object dblResponsavelImp: TDBLookupComboBox
          Left = 10
          Top = 89
          Width = 241
          Height = 26
    ...
    object tsAcoes: TTabSheet
      ...
      object lbl20: TLabel
        ...
        Width = 111
        Height = 13
        Caption = 'Respons'#225'vel pela A'#231#227'o'
        Color = clBackground
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
      ...
      object lbl21: TLabel
        ...
        Width = 110
        Height = 13
        Caption = 'Resultados Alcan'#231'ados'
        Color = clBackground
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
      ...
      object dbgAcoesPMC: TDBGrid
        ...
        TitleFont.Name = 'Tahoma'
        TitleFont.Style = []
        OnCellClick = dbgAcoesPMCCellClick
        OnKeyUp = dbgAcoesPMCKeyUp
        Columns = <
          item
            Expanded = False
      ...
      object mmoSaidas: TMemo
        ...
        ShowHint = True
        TabOrder = 6
        OnKeyPress = mmoSaidasKeyPress
      end
      object dtPrazoAcao: TDateEdit
        Left = 584
        Top = 170
        Width = 105
        Height = 26
      ...
      object dblResponsavelAcao: TDBLookupComboBox
        Left = 297
        Top = 170
        Width = 281
        Height = 26
        ...
        KeyField = 'codi_col'
        ListField = 'nome_col'
        ListSource = dsResponsavelAcao
        ParentFont = False
        TabOrder = 2
      end
      object mmoResultados: TMemo
        Left = 350
        Top = 263
        Width = 388
        Height = 101
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT A.codi_ana, A.entr_ana, A.resu_ana, C.aac_resultados as R' +
        'esultados, '
      
        'C.codi_aac, C.pare_aac, C.praz_aac, C.proc_aac, C.resp_aac, C.sa' +
        'id_aac,'
      'C.dcad_aac'
      'from analise A'
  ...
  object cdsImprimir: TClientDataSet
    ...
    object cdsImprimirNomeResp: TStringField
      FieldKind = fkLookup
      FieldName = 'NomeResp'
      LookupDataSet = cdsResponsavelAcao
    ...
    object cdsImprimircodi_ana: TLargeintField
      FieldName = 'codi_ana'
      Required = True
    end
    object cdsImprimirentr_ana: TWideMemoField
      FieldName = 'entr_ana'
      BlobType = ftWideMemo
    end
    object cdsImprimirresu_ana: TWideMemoField
      FieldName = 'resu_ana'
      BlobType = ftWideMemo
    end
    object cdsImprimircodi_aac: TLargeintField
      FieldName = 'codi_aac'
      Required = True
    end
    object cdsImprimirpare_aac: TWideStringField
      FieldName = 'pare_aac'
      Required = True
      Size = 150
    end
    object cdsImprimirpraz_aac: TDateTimeField
      FieldName = 'praz_aac'
      Required = True
    end
    object cdsImprimirproc_aac: TLargeintField
      FieldName = 'proc_aac'
      Required = True
    end
    object cdsImprimirresp_aac: TLargeintField
      FieldName = 'resp_aac'
      Required = True
    end
    object cdsImprimirsaid_aac: TWideMemoField
      FieldName = 'said_aac'
      Required = True
      BlobType = ftWideMemo
    end
    object cdsImprimirdcad_aac: TDateTimeField
      FieldName = 'dcad_aac'
    end
    object cdsImprimirresultados: TWideMemoField
      FieldName = 'resultados'
      ReadOnly = True
      BlobType = ftWideMemo
    end
  end
  object zqryEntradas: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_ana, entr_ana, resu_ana '
      'FROM analise'
      'ORDER BY entr_ana')
    Params = <>
    Left = 136
  ...
  object cdsEntradas: TClientDataSet
    ...
    OnCalcFields = cdsEntradasCalcFields
    Left = 216
    Top = 440
    object cdsEntradasEntrada: TStringField
      FieldKind = fkCalculated
      FieldName = 'Entrada'
      Size = 80
      Calculated = True
    end
    object cdsEntradascodi_ana: TLargeintField
      FieldName = 'codi_ana'
      Required = True
    end
    object cdsEntradasentr_ana: TWideMemoField
      FieldName = 'entr_ana'
      BlobType = ftWideMemo
    end
    object cdsEntradasresu_ana: TWideMemoField
      FieldName = 'resu_ana'
      BlobType = ftWideMemo
    end
  end
  ...
  object dspAcoes: TDataSetProvider
    DataSet = zqryAcoes
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 176
  ...
  object cdsAcoes: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspAcoes'
    Left = 216
    Top = 488
    object cdsAcoesNomeResp: TStringField
      FieldKind = fkLookup
      FieldName = 'NomeResp'
      LookupDataSet = cdsResponsavelAcao
      LookupKeyFields = 'codi_col'
    ...
    object cdsAcoesDescProcesso: TStringField
      FieldKind = fkLookup
      FieldName = 'DescProcesso'
    ...
    object cdsAcoescodi_aac: TLargeintField
      FieldName = 'codi_aac'
      Required = True
    end
    object cdsAcoescodi_ana: TLargeintField
      FieldName = 'codi_ana'
      Required = True
    end
    object cdsAcoespare_aac: TWideStringField
      FieldName = 'pare_aac'
      Required = True
      Size = 150
    end
    object cdsAcoespraz_aac: TDateTimeField
      FieldName = 'praz_aac'
      Required = True
    end
    object cdsAcoesresp_aac: TLargeintField
      FieldName = 'resp_aac'
      Required = True
    end
    object cdsAcoessaid_aac: TWideMemoField
      FieldName = 'said_aac'
      Required = True
      BlobType = ftWideMemo
    end
    object cdsAcoesproc_aac: TLargeintField
      FieldName = 'proc_aac'
      Required = True
    end
    object cdsAcoesdcad_aac: TDateTimeField
      FieldName = 'dcad_aac'
    end
    object cdsAcoesaac_resultados: TWideMemoField
  ...
  object zqryResponsavelAcao: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
  ...
  object dspResponsavelAcao: TDataSetProvider
    DataSet = zqryResponsavelAcao
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 408
    Top = 440
  end
  object cdsResponsavelAcao: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspResponsavelAcao'
    Left = 448
    Top = 440
  ...
  object dsResponsavelAcao: TDataSource
    DataSet = cdsResponsavelAcao
    Left = 488
    Top = 440
  end
  object zqryRespImp: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_col, nome_col'
      'FROM Colaboradores'
  ...
  object dspRespImp: TDataSetProvider
    DataSet = zqryRespImp
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 616
  ...
  object cdsRespImp: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspRespImp'
    Left = 656
    Top = 440
  ...
  object dsRespImp: TDataSource
    DataSet = cdsRespImp
    Left = 696
    Top = 440
  end
  object zqryProcessosImp: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_pro, nome_pro '
      'FROM processos'
  ...
  object dspProcessosImp: TDataSetProvider
    DataSet = zqryProcessosImp
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 616
    Top = 488
  end
  object cdsProcessosImp: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspProcessosImp'
    Left = 656
    Top = 488
