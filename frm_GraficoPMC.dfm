object FormGraficoPMC: TFormGraficoPMC
  Left = 0
  Top = 0
      ...
      object DBAdvGDIPChartView1: TDBAdvGDIPChartView
        ...
        Panes = <
          item
            ...
            Title.Position = tTop
            Title.Text = 'PMC Aguardando An'#225'lise de Causa'
      ...
      object DBAdvGDIPChartView2: TDBAdvGDIPChartView
        ...
        Panes = <
          item
            ...
            Title.Font.Style = [fsBold]
            Title.Position = tTop
            Title.Text = 'PMC sem Plano de A'#231#227'o'
            XAxis.Font.Charset = DEFAULT_CHARSET
            XAxis.Font.Color = clBlack
            XAxis.Font.Height = -11
            XAxis.Font.Name = 'Tahoma'
      ...
      object DBAdvGDIPChartView3: TDBAdvGDIPChartView
        ...
        Panes = <
          item
            ...
            Title.Font.Style = [fsBold]
            Title.Position = tTop
            Title.Text = 'A'#231#245'es de PMC vencidas'
            XAxis.Font.Charset = DEFAULT_CHARSET
            XAxis.Font.Color = clBlack
            XAxis.Font.Height = -11
            XAxis.Font.Name = 'Tahoma'
      ...
      object DBAdvGDIPChartView5: TDBAdvGDIPChartView
        ...
        Panes = <
          item
            ...
            Title.Font.Style = [fsBold]
            Title.Position = tTop
            Title.Text = 'RNC Aguardando Resposta/Disposi'#231#227'o'
            XAxis.Font.Charset = DEFAULT_CHARSET
            XAxis.Font.Color = clBlack
            XAxis.Font.Height = -11
            XAxis.Font.Name = 'Tahoma'
      ...
      object DBAdvGDIPChartView6: TDBAdvGDIPChartView
        ...
        Panes = <
          item
            ...
            Title.Font.Style = [fsBold]
            Title.Position = tTop
            Title.Text = 'RNC a Finalizar (Aceite/Recusa)'
            XAxis.Font.Charset = DEFAULT_CHARSET
            XAxis.Font.Color = clBlack
            XAxis.Font.Height = -11
            XAxis.Font.Name = 'Tahoma'
          ...
          item
            ...
            Series = <
              item
                ...
                YAxis.MajorFont.Name = 'Tahoma'
                YAxis.MajorFont.Style = []
                YAxis.MajorUnit = 5.000000000000000000
                YAxis.MajorUnitSpacing = 0
                YAxis.MinorFont.Charset = DEFAULT_CHARSET
                YAxis.MinorFont.Color = clWindowText
                YAxis.MinorFont.Height = -11
            ...
            Title.Font.Style = [fsBold]
            Title.Position = tTop
            Title.Text = 'A'#231#245'es em Andamento, Atrasadas, Conclu'#237'das'
            XAxis.Font.Charset = DEFAULT_CHARSET
            XAxis.Font.Color = clBlack
            XAxis.Font.Height = -11
            XAxis.Font.Name = 'Tahoma'
  ...
  object pnlFiltro: TPanel
    ...
    object btnAtualizar: TBitBtn
      ...
      Width = 73
      Height = 61
      Hint = 'Clique para atualizar os gr'#225'ficos com o per'#237'odo desejado'
      Caption = '&Atualizar'
      DoubleBuffered = True
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
    ...
    object rgOpcoes: TRadioGroup
      ...
      Columns = 2
      Items.Strings = (
        'A'#231#245'es Vencidas'
        'A'#231#245'es a Vencer'
        'Todas')
      TabOrder = 5
      Visible = False
      OnClick = rgTipoGraficoClick
  ...
  object zqryPMCsemCausa: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT P.nome_pro as Processo, COUNT(*) as Qtde'
      'FROM pmc'
      'INNER JOIN processos P ON P.codi_pro = prcs_pmc'
      'WHERE caus_pmc isnull OR caus_pmc = '#39#39
      'GROUP BY P.nome_pro')
    Params = <>
    Left = 96
    Top = 232
  ...
  object cdsPMCsemCausa: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspPMCsemCausa'
    Left = 176
    Top = 232
    object cdsPMCsemCausaprocesso: TWideStringField
      FieldName = 'processo'
      ReadOnly = True
      Size = 45
    end
    object cdsPMCsemCausaqtde: TLargeintField
      FieldName = 'qtde'
      ReadOnly = True
    end
  end
  ...
  object dspPMCsemAcao: TDataSetProvider
    DataSet = zqryPMCsemAcao
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 136
    Top = 280
  end
  object cdsPMCsemAcao: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspPMCsemAcao'
    Left = 176
    Top = 280
    object cdsPMCsemAcaoprocesso: TWideStringField
      FieldName = 'processo'
      ReadOnly = True
      Size = 45
    end
    object cdsPMCsemAcaoqtde: TLargeintField
      FieldName = 'qtde'
      ReadOnly = True
    end
  end
  object dsPMCsemAcao: TDataSource
    DataSet = cdsPMCsemAcao
    Left = 216
    Top = 280
  end
  ...
  object zqryAcoesPMCVenc: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT P.nome_pro as Processo, COUNT(*) as Qtde'
      'FROM pmc'
  ...
  object dspAcoesPMCVenc: TDataSetProvider
    DataSet = zqryAcoesPMCVenc
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 136
    Top = 328
  end
  object cdsAcoesPMCVenc: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspAcoesPMCVenc'
    Left = 176
    Top = 328
    ...
    object cds3: TLargeintField
      FieldName = 'qtde'
      ReadOnly = True
    end
  end
  object dsAcoesPMCVenc: TDataSource
    DataSet = cdsAcoesPMCVenc
    Left = 216
    Top = 328
  end
  object zqryAcoesResp: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      
        'SELECT SUBSTRING(C.nome_col, 1, POSITION('#39' '#39' in C.nome_col) - 1)' +
        ' as Responsavel, '
      'COUNT(*) as Qtde'
      'FROM pmc_acoes'
      'INNER JOIN Colaboradores C ON C.codi_col = resp_aco'
      'GROUP BY C.nome_col')
    Params = <>
    Left = 96
    Top = 376
  end
  object dspAcoesResp: TDataSetProvider
    DataSet = zqryAcoesResp
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 136
    Top = 376
  end
  object cdsAcoesResp: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspAcoesResp'
    Left = 176
    Top = 376
    object cdsAcoesRespresponsavel: TWideMemoField
      FieldName = 'responsavel'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object cdsAcoesRespqtde: TLargeintField
      FieldName = 'qtde'
      ReadOnly = True
    end
  end
  object dsAcoesResp: TDataSource
    DataSet = cdsAcoesResp
    Left = 216
    Top = 376
  end
  object zqryAcoesGeral: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_pro, '
      'CASE WHEN pro_nome_abreviado = '#39#39
      ...
      'WHERE PA.vimp_aco = '#39#39' AND PA.aco_prazo > '#39'2017-08-08'#39
  ...
  object dspAcoesGeral: TDataSetProvider
    DataSet = zqryAcoesGeral
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 328
    Top = 232
  end
  object cdsAcoesGeral: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspAcoesGeral'
    Left = 368
    Top = 232
    object cdsAcoesGeralcodi_pro: TLargeintField
      FieldName = 'codi_pro'
      Required = True
    end
    object cdsAcoesGeralprocesso: TWideStringField
      FieldName = 'processo'
      ReadOnly = True
      Size = 255
    end
    object cdsAcoesGeralaberto: TLargeintField
      FieldName = 'aberto'
      ReadOnly = True
    end
    object cdsAcoesGeralvencido: TLargeintField
      FieldName = 'vencido'
      ReadOnly = True
    end
    object cdsAcoesGeralfechado: TLargeintField
      FieldName = 'fechado'
      ReadOnly = True
    end
  end
  object dsAcoesGeral: TDataSource
    DataSet = cdsAcoesGeral
    Left = 408
    Top = 232
  end
  object zqryRNCAberto: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT CASE WHEN P.pro_nome_abreviado = '#39#39
  ...
  object dspRNCAberto: TDataSetProvider
    DataSet = zqryRNCAberto
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 328
    Top = 280
  end
  object cdsRNCAberto: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspRNCAberto'
    Left = 368
    Top = 280
    object cdsRNCAbertoprocesso: TWideStringField
      FieldName = 'processo'
      ReadOnly = True
      Size = 255
    end
    object cdsRNCAbertoqtde: TLargeintField
      FieldName = 'qtde'
      ReadOnly = True
    end
  end
  object dsRNCAberto: TDataSource
    DataSet = cdsRNCAberto
    Left = 408
    Top = 280
  end
  ...
  object zqryRNCFinalizar: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT CASE WHEN P.pro_nome_abreviado = '#39#39
      '   OR P.pro_nome_abreviado isnull'
  ...
  object dspRNCFinalizar: TDataSetProvider
    DataSet = zqryRNCFinalizar
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 328
    Top = 328
  end
  object cdsRNCFinalizar: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspRNCFinalizar'
    Left = 368
    Top = 328
    ...
    object cds5: TLargeintField
      FieldName = 'qtde'
      ReadOnly = True
    end
  end
  object dsRNCFinalizar: TDataSource
    DataSet = cdsRNCFinalizar
    Left = 408
    Top = 328
  end
  object zqryRNCMotivo: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT TC.valo_com as Motivo,'
      'COUNT(*) AS Qtde'
      'FROM rnc R'
      
        'INNER JOIN tabela_combos TC ON TC.tipo_com = 32 AND TC.codi_com ' +
        '= rnc_motivo'
  ...
  object dspRNCMotivo: TDataSetProvider
    DataSet = zqryRNCMotivo
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 328
    Top = 376
  end
  object cdsRNCMotivo: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspRNCMotivo'
    Left = 368
    Top = 376
    object cdsRNCMotivomotivo: TWideStringField
      FieldName = 'motivo'
      ReadOnly = True
      Size = 50
    end
    object cdsRNCMotivoqtde: TLargeintField
      FieldName = 'qtde'
      ReadOnly = True
    end
  end
  object dsRNCMotivo: TDataSource
    DataSet = cdsRNCMotivo
    Left = 408
    Top = 376
  end
  object zqryRNCProcesso: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT CASE WHEN P.pro_nome_abreviado = '#39#39
      '   OR P.pro_nome_abreviado isnull'
  ...
  object dspRNCProcesso: TDataSetProvider
    DataSet = zqryRNCProcesso
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 328
    Top = 424
  end
  object cdsRNCProcesso: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspRNCProcesso'
    Left = 368
    Top = 424
    object cdsRNCProcessoprocesso: TWideStringField
      FieldName = 'processo'
      ReadOnly = True
      Size = 255
    end
    object cdsRNCProcessoqtde: TLargeintField
      FieldName = 'qtde'
      ReadOnly = True
    end
  end
  object dsRNCProcesso: TDataSource
    DataSet = cdsRNCProcesso
    Left = 408
    Top = 424
  end
end
