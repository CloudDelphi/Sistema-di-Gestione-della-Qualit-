object FormCarta: TFormCarta
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object wbAtualizacao: TWebBrowser
    Left = 0
    Top = 0
    Width = 830
    Height = 482
    ...
    ExplicitHeight = 433
    ControlData = {
      4C000000C8550000D13100000000000000000000000000000000000000000000
  ...
  object pnl1: TPanel
    ...
    Align = alBottom
    TabOrder = 1
    object chkMostrar: TCheckBox
      Left = 16
      Top = 26
      Width = 129
      Height = 17
      Caption = 'N'#227'o mostrar mais'
      TabOrder = 0
      OnClick = chkMostrarClick
    end
    object btn1: TBitBtn
      Left = 756
      Top = 1
