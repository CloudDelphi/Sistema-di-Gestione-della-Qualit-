object FormCadFornecedores: TFormCadFornecedores
  Left = 0
  Top = 0
  ...
  object pctForn: TJvgPageControl
    Left = 0
    Top = 0
    Width = 866
    Height = 460
    ...
    object tsCadastro: TTabSheet
      ...
      object lbl4: TLabel
        ...
        Width = 166
        Height = 13
        Caption = 'Caminho do Arquivo do Certificado'
      end
      ...
      object dtInclusao: TDateEdit
        ...
        Width = 103
        Height = 26
        Hint = 'Digite a data de inclus'#227'o do fornecedor no cadastro'
      ...
      object mmoArea: TMemo
        ...
        Width = 444
        Height = 113
        Hint = 'Digite a '#225'rea de atua'#231#227'o do fornecedor'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -15
        Font.Name = 'Tahoma'
      ...
      object dblTipoProd: TDBLookupComboBox
        Left = 7
        Top = 223
        Width = 268
        Height = 26
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        KeyField = 'tipo_codigo'
        ListField = 'tipo_nomeTipo'
      ...
      object pnlImprimir: TPanel
        ...
        object dblTipoProdImp: TDBLookupComboBox
          Tag = 10
          Left = 13
          Top = 108
          Width = 268
        ...
        object rgSituacao: TRadioGroup
          ...
          Width = 337
          Height = 59
          Caption = 'Status dos Fornecedores'
          Columns = 3
          ItemIndex = 0
          Items.Strings = (
            'Ativos'
        ...
        object chkSeparaProduto: TCheckBox
          Tag = 30
          Left = 13
          Top = 143
          Width = 188
          Height = 17
          Caption = 'Separa por tipo de produto'
          TabOrder = 3
        end
    ...
    object tsDocumentos: TTabSheet
      ...
      object dtValidadeDoc: TDateEdit
        Left = 749
        Top = 72
        Width = 103
        Height = 26
        Hint = 'Digite a validade do documento'
        DialogTitle = 'Selecione uma data'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -15
    ...
    object tsAvaliacao: TTabSheet
      Caption = 'Pontua'#231#227'o de Qualifica'#231#227'o'
      ImageIndex = 3
      object lbl28: TLabel
        Left = 7
        Top = 56
      ...
      object dbgAvaliacao: TDBGrid
        Left = 3
        Top = 117
        Width = 852
        Height = 312
        DataSource = dsQualificacao
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Tahoma'
      ...
      object edtPontuacao: TCurrencyEdit
        Tag = 30
        Left = 7
        Top = 72
        Width = 87
      ...
      object dtValidadeQualif: TDateEdit
        Tag = 30
        Left = 99
        Top = 72
        Width = 103
      ...
      object btnInserirQualif: TBitBtn
        Left = 216
        Top = 60
        Width = 82
        Height = 51
        ...
        ShowHint = True
        TabOrder = 3
        OnClick = btnInserirQualifClick
      end
      object btnExcluirQualif: TBitBtn
        Left = 304
        Top = 60
        Width = 82
        Height = 51
  ...
  object zqryImprimir: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT forn_codigo, forn_nome, forn_tipoProd,'
      
        '(SELECT MAX(for_data_validade) FROM forn_avaliacao WHERE for_cod' +
        'for = forn_codigo) AS validade,'
      '(SELECT for_avaliacao FROM forn_avaliacao '
      ' WHERE for_codfor = forn_codigo'
      ' ORDER BY for_data_validade DESC LIMIT 1) AS avaliacao,'
      'T.tipo_nometipo as DescTipoProd'
      'FROM fornecedores F'
      'LEFT JOIN forn_tipo_produto T ON T.tipo_codigo = forn_tipoProd'
      'WHERE forn_codigo < 999999'
      'ORDER BY forn_codigo')
    Params = <>
    Left = 688
    Top = 352
  end
  ...
  object cdsImprimir: TClientDataSet
    ...
    object cdsImprimirforn_codigo: TIntegerField
      FieldName = 'forn_codigo'
      Required = True
    end
    object cdsImprimiravaliacao: TFloatField
      FieldName = 'avaliacao'
    end
    object cdsImprimirvalidade: TDateTimeField
      FieldName = 'validade'
      ReadOnly = True
    end
    object cdsImprimirdesctipoprod: TWideStringField
      FieldName = 'desctipoprod'
      ReadOnly = True
      Size = 100
    end
  end
  object zqryForn: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT forn_area, forn_bairro, forn_cep, forn_cidade, forn_CNPJ,' +
        ' forn_codigo, forn_contato,'
      
        'forn_endereco, forn_estado, forn_fantasia, forn_fone, forn_inscE' +
        'st, forn_mail, forn_nome, forn_numero,'
      
        'forn_obs, forn_certificado, forn_tipoProd, forn_status, forn_dat' +
        'a_inclusao,'
      '(SELECT for_avaliacao'
      ' FROM forn_avaliacao'
      ' WHERE for_codfor = forn_codigo'
      ' ORDER BY for_data_validade DESC LIMIT 1) as Avaliacao,'
      ' (SELECT for_data_validade'
      ' FROM forn_avaliacao'
      ' WHERE for_codfor = forn_codigo'
      ' ORDER BY for_data_validade DESC LIMIT 1) as Validade'
      'FROM fornecedores'
      'WHERE forn_codigo <> 999999'
      'ORDER BY forn_nome')
    Params = <>
  ...
  object cdsForn: TClientDataSet
    ...
    Left = 168
    Top = 320
    object cdsFornforn_area: TWideMemoField
      FieldName = 'forn_area'
      BlobType = ftWideMemo
    end
    object cdsFornforn_bairro: TWideStringField
      FieldName = 'forn_bairro'
      Size = 40
    end
    object cdsFornforn_cep: TWideStringField
      FieldName = 'forn_cep'
      Size = 9
    end
    object cdsFornforn_cidade: TWideStringField
      FieldName = 'forn_cidade'
      Size = 50
    end
    object cdsFornforn_cnpj: TWideStringField
      FieldName = 'forn_cnpj'
    end
    ...
    object cdsFornforn_contato: TWideStringField
      FieldName = 'forn_contato'
      Size = 30
    end
    object cdsFornforn_endereco: TWideStringField
      FieldName = 'forn_endereco'
      Size = 50
    end
    object cdsFornforn_estado: TWideStringField
    ...
    object cdsFornforn_fone: TWideStringField
      FieldName = 'forn_fone'
    end
    object cdsFornforn_inscest: TWideStringField
      FieldName = 'forn_inscest'
    end
    object cdsFornforn_mail: TWideStringField
      FieldName = 'forn_mail'
      Size = 50
    end
    ...
    object cdsFornforn_numero: TWideStringField
      FieldName = 'forn_numero'
      Size = 6
    end
    object cdsFornforn_obs: TWideMemoField
      FieldName = 'forn_obs'
      BlobType = ftWideMemo
    end
    object cdsFornforn_certificado: TWideStringField
      FieldName = 'forn_certificado'
      Size = 250
    end
    object cdsFornforn_tipoprod: TIntegerField
      FieldName = 'forn_tipoprod'
    end
    object cdsFornforn_status: TIntegerField
      FieldName = 'forn_status'
    end
    object cdsFornavaliacao: TFloatField
      FieldName = 'avaliacao'
      ReadOnly = True
      DisplayFormat = '##0.00'
    end
    object cdsFornvalidade: TDateTimeField
      FieldName = 'validade'
      ReadOnly = True
    end
    object cdsFornforn_data_inclusao: TDateTimeField
      FieldName = 'forn_data_inclusao'
    end
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43524.610995347200000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSFicha
        DataSetName = 'frxDBDSFicha'
      end>
    Variables = <
      item
        Name = ' Destra'
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Shape1: TfrxShapeView
          Top = 73.322834650000000000
          Width = 718.487993700000000000
          Height = 22.677180000000000000
          ShowHint = False
          Color = cl3DLight
        end
        object Memo4: TfrxMemoView
          Top = 20.267780000000000000
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo10: TfrxMemoView
          ...
          Memo.UTF8W = (
            '[frxDBDSFicha."forn_nome"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo3: TfrxMemoView
          Left = 458.015562520000000000
          Top = 19.000000000000000000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSFicha."forn_cnpj"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo7: TfrxMemoView
          Left = 601.582870000000000000
          Top = 19.000000000000000000
        ...
        object Memo6: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSFicha."forn_codigo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo14: TfrxMemoView
          Top = 56.574830000000020000
        ...
        object Memo16: TfrxMemoView
          Left = 548.543307090000000000
          Top = 56.574830000000020000
          Width = 166.299044170000000000
          Height = 18.897650000000000000
          ShowHint = False
          Color = cl3DLight
          DisplayFormat.DecimalSeparator = ','
        ...
        object Memo8: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBDSFicha."forn_endereco"], [frxDBDSFicha."forn_numero"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo17: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSFicha."forn_bairro"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo18: TfrxMemoView
          Left = 548.654197480000000000
          Top = 75.692950000000000000
          Width = 166.299044169999000000
          Height = 37.795275590000000000
          ShowHint = False
          DataSet = frxDBDSFicha
          DataSetName = 'frxDBDSFicha'
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSFicha."forn_cidade"] - [frxDBDSFicha."forn_estado"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDSFicha."DescTipoProd"'
        object Memo19: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            ' Tipo de Produto: [frxDBDSFicha."DescTipoProd"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object frxDBForn: TfrxDBDataset
    UserName = 'frxDBForn'
  ...
  object zqryTipoProd: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT tipo_codigo, tipo_nomeTipo'
      'FROM forn_tipo_produto'
      'ORDER BY tipo_nomeTipo')
    Params = <>
    Left = 88
    Top = 367
  end
  object dspTipoProd: TDataSetProvider
    DataSet = zqryTipoProd
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 128
    Top = 367
  ...
  object cdsTipoProd: TClientDataSet
    ...
    Left = 168
    Top = 367
    object cdsTipoProdtipo_codigo: TIntegerField
      FieldName = 'tipo_codigo'
      Required = True
    end
    object cdsTipoProdtipo_nomeTipo: TWideStringField
  ...
  object zqryDocs: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT for_codigo, doc_codigo, doc_descricao, doc_caminho, doc_d' +
        'ata_validade'
  ...
  object cdsDocs: TClientDataSet
    ...
    Left = 376
    Top = 416
    object cdsDocsfor_codigo: TIntegerField
    ...
    object cdsDocsdoc_data_validade: TDateTimeField
      FieldName = 'doc_data_validade'
    end
  end
  ...
  object zqryTipoProdImp: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT tipo_codigo, tipo_nomeTipo'
      'FROM forn_tipo_produto'
  ...
  object dspTipoProdImp: TDataSetProvider
    DataSet = zqryTipoProdImp
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 336
    Top = 367
  end
  object cdsTipoProdImp: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspTipoProdImp'
    Left = 376
    Top = 367
  ...
  object dsTipoProdImp: TDataSource
    DataSet = cdsTipoProdImp
    Left = 416
    Top = 367
  end
  object zqryQualificacao: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT for_codigo, for_codfor, for_data_validade, for_avaliacao'
      'FROM forn_avaliacao')
    Params = <>
    Left = 88
    Top = 167
  end
  object dspQualificacao: TDataSetProvider
    DataSet = zqryQualificacao
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 128
    Top = 167
  end
  object cdsQualificacao: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspQualificacao'
    Left = 168
    Top = 167
    object cdsQualificacaofor_codigo: TIntegerField
      FieldName = 'for_codigo'
      Required = True
    end
    object cdsQualificacaofor_codfor: TIntegerField
      FieldName = 'for_codfor'
      Required = True
    end
    object cdsQualificacaofor_data_validade: TDateTimeField
      FieldName = 'for_data_validade'
    end
    object cdsQualificacaofor_avaliacao: TFloatField
      FieldName = 'for_avaliacao'
      DisplayFormat = '##0.00'
    end
  end
  object dsQualificacao: TDataSource
    DataSet = cdsQualificacao
    Left = 208
    Top = 167
  end
  object frxDBDSFicha: TfrxDBDataset
    UserName = 'frxDBDSFicha'
    CloseDataSource = False
    FieldAliases.Strings = (
      'forn_codigo=forn_codigo'
      'forn_nome=forn_nome'
      ...
      'forn_data_inclusao=forn_data_inclusao'
      'desctipoprod=DescTipoProd')
    DataSet = cdsImprimirFicha
    BCDToCurrency = False
    Left = 600
    Top = 400
  end
  object zqryImprimirFicha: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT forn_codigo, forn_nome, forn_tipoProd,'
      'forn_endereco, forn_numero, forn_bairro, forn_cidade,'
      'forn_estado, forn_cep, forn_fone, forn_cnpj, forn_inscest,'
      'forn_data_inclusao, T.tipo_nometipo as DescTipoProd'
      'FROM fornecedores'
      'LEFT JOIN forn_tipo_produto T ON T.tipo_codigo = forn_tipoProd'
      'WHERE forn_codigo < 999999')
    Params = <>
  ...
  object dspImprimirFicha: TDataSetProvider
    DataSet = zqryImprimirFicha
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 728
    Top = 400
  end
  object cdsImprimirFicha: TClientDataSet
    Active = True
    Aggregates = <>
    Params = <>
    ProviderName = 'dspImprimirFicha'
    Left = 768
    Top = 400
    object cdsImprimirFichaforn_codigo: TIntegerField
      FieldName = 'forn_codigo'
      Required = True
    end
    object cdsImprimirFichaforn_nome: TWideStringField
      FieldName = 'forn_nome'
      Size = 80
    end
    object cdsImprimirFichaforn_tipoprod: TIntegerField
      FieldName = 'forn_tipoprod'
    end
    object cdsImprimirFichaforn_endereco: TWideStringField
      FieldName = 'forn_endereco'
      Size = 50
    end
    object cdsImprimirFichaforn_numero: TWideStringField
      FieldName = 'forn_numero'
      Size = 15
    end
    object cdsImprimirFichaforn_bairro: TWideStringField
      FieldName = 'forn_bairro'
      Size = 40
    end
    object cdsImprimirFichaforn_cidade: TWideStringField
      FieldName = 'forn_cidade'
      Size = 50
    end
    object cdsImprimirFichaforn_estado: TWideStringField
      FieldName = 'forn_estado'
      Size = 2
    end
    object cdsImprimirFichaforn_cep: TWideStringField
      FieldName = 'forn_cep'
      Size = 9
    end
    object cdsImprimirFichaforn_fone: TWideStringField
      FieldName = 'forn_fone'
    end
    object cdsImprimirFichaforn_cnpj: TWideStringField
      FieldName = 'forn_cnpj'
    end
    object cdsImprimirFichaforn_inscest: TWideStringField
      FieldName = 'forn_inscest'
    end
    object cdsImprimirFichaforn_data_inclusao: TDateTimeField
      FieldName = 'forn_data_inclusao'
    end
    object cdsImprimirFichadesctipoprod: TWideStringField
      FieldName = 'desctipoprod'
      ReadOnly = True
      Size = 100
    end
