object FormCadFornecedores: TFormCadFornecedores
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT forn_codigo, forn_nome, forn_avaliacao, forn_validade, fo' +
        'rn_tipoProd'
      'FROM fornecedores'
      ''
      '')
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42069.734344178200000000
  ...
  object zqryDocs: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT for_codigo, doc_codigo, doc_descricao, doc_caminho'
