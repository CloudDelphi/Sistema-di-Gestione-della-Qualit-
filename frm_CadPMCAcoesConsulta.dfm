object FormCadPMCAcoesConsulta: TFormCadPMCAcoesConsulta
  Left = 0
  Top = 0
  ...
  object lbllb1: TLabel
    ...
    Width = 103
    Height = 13
    Caption = 'Respons'#225'vel da A'#231#227'o'
    Color = clBackground
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = -11
  ...
  object dbg1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'aco_prazo'
        Title.Caption = 'Prazo A'#231#227'o'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
        Title.Font.Name = 'Tahoma'
  ...
  object cdsImprimir: TClientDataSet
    ...
    object Imprimirdesc_aco: TWideMemoField
      FieldName = 'desc_aco'
      BlobType = ftWideMemo
    end
    object cdsImprimirresponsavelacao: TWideStringField
      FieldName = 'responsavelacao'
      ReadOnly = True
      Size = 45
    end
    object Imprimiraco_prazo: TDateTimeField
      FieldName = 'aco_prazo'
    end
  end
  object zqryAcoesPMC: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
  ...
  object dspAcoesPMC: TDataSetProvider
    DataSet = zqryAcoesPMC
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 168
    Top = 216
  end
  object cdsAcoesPMC: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspAcoesPMC'
    Left = 208
    Top = 216
    object cdsAcoesPMCnume_pmc: TWideStringField
      FieldName = 'nume_pmc'
      Size = 15
    end
    object cdsAcoesPMCtipo: TWideStringField
      FieldName = 'tipo'
      ReadOnly = True
      Size = 50
    end
    object cdsAcoesPMCaco_prazo: TDateTimeField
      FieldName = 'aco_prazo'
    end
    object cdsAcoesPMCresponsavel: TWideStringField
      FieldName = 'responsavel'
      ReadOnly = True
      Size = 45
    end
  ...
  object cdsGrafico: TClientDataSet
    ...
    Left = 679
    Top = 360
    object cdsGraficoresponsavel: TWideMemoField
      FieldName = 'responsavel'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object cdsGraficoqtde: TLargeintField
      FieldName = 'qtde'
      ReadOnly = True
    end
  end
