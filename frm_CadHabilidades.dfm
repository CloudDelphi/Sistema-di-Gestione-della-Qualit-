object FormCadHabilidades: TFormCadHabilidades
  Left = 0
  Top = 0
  ...
  object pctHabilidades: TJvgPageControl
    ...
    object tsCadastro: TTabSheet
      ...
      object lbl16: TLabel
        ...
        Width = 113
        Height = 13
        Caption = 'Descri'#231#227'o da Habilidade'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object mmoEspecificação: TMemo
        ...
        TabOrder = 2
        OnExit = mmoEspecificaçãoExit
        OnKeyPress = mmoEspecificaçãoKeyPress
      end
    end
      ...
      object dbgHabilidades: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'desc_hab'
            Title.Caption = 'Nome da Habilidade'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object zqryHabilidades: TZQuery
    ...
    SQL.Strings = (
      'SELECT codi_hab, desc_hab, hab_especificacao'
      'FROM habilidades'
      'ORDER BY desc_hab')
    Params = <>
    Left = 64
  ...
  object cdsHabilidades: TClientDataSet
    ...
    object cdsHabilidadeshab_especificacao: TWideMemoField
      FieldName = 'hab_especificacao'
      ReadOnly = True
      BlobType = ftWideMemo
    end
  end
  ...
  object frxDBDSHabilidades: TfrxDBDataset
    UserName = 'frxDBDSHabilidades'
    CloseDataSource = False
    FieldAliases.Strings = (
      'codi_hab=codi_hab'
      'desc_hab=desc_hab'
      'hab_especificacao=hab_especificacao')
    DataSet = cdsImprimir
    BCDToCurrency = False
    Left = 304
    Top = 216
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 440
    Top = 216
    object cdsImprimircodi_hab: TIntegerField
      FieldName = 'codi_hab'
      Required = True
    end
    object cdsImprimirdesc_hab: TWideStringField
      FieldName = 'desc_hab'
      Size = 50
    end
    object cdsImprimirhab_especificacao: TWideMemoField
      FieldName = 'hab_especificacao'
      ReadOnly = True
      BlobType = ftWideMemo
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42405.400558715280000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSHabilidades
        DataSetName = 'frxDBDSHabilidades'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo1: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBDSHabilidades."hab_especificacao"]')
          ParentFont = False
        end
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Descri'#231#227'o da Habilidade')
          ParentFont = False
          VAlign = vaBottom
        end
