object FormCadIQFDemerito: TFormCadIQFDemerito
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Lan'#231'amento de Dem'#233'rito de Fornecedor'
  ClientHeight = 484
  ClientWidth = 1022
  Color = clBtnFace
    ...
    object tsCadastro: TTabSheet
      ...
      object pnlDemerito: TPanel
        ...
        object lbl8: TLabel
          ...
          Width = 130
          Height = 13
          Caption = 'Respons'#225'vel pelo Dem'#233'rito'
        end
        object lbl11: TLabel
          Left = 0
          Top = 83
        ...
        object dblRespDemerito: TDBLookupComboBox
          Left = 0
          Top = 51
          Width = 392
          Height = 26
          ...
          KeyField = 'codi_col'
          ListField = 'nome_col'
          ListSource = dsRespDemerito
          ParentFont = False
          TabOrder = 0
        end
        object mmoObsDemerito: TMemo
          Left = 0
          Top = 102
          Width = 489
          Height = 149
        ...
        object pnl8: TPanel
          ...
          Caption = ' Demeritar Fornecedor (Conformidade)'
        ...
        object edtDemerito: TCurrencyEdit
          Tag = 20
          Left = 400
          Top = 51
          Width = 81
    ...
    object tsPesquisa: TTabSheet
      ...
      object dbgIQF: TDBGrid
        ...
        Columns = <
          item
            Expanded = False
            FieldName = 'dem_cod_iqf'
            Title.Caption = 'C'#243'digo IQF'
          ...
          item
            Expanded = False
            FieldName = 'dem_nota_demerito'
            Title.Caption = 'Nota de Dem'#233'rito'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object pnlImprimir: TPanel
    ...
    object pnl4: TPanel
      ...
      object lbl15: TLabel
        ...
        Width = 97
        Height = 13
        Caption = 'Per'#237'odo do Dem'#233'rito'
        Color = clBackground
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT D.dem_codigo, D.dem_cod_iqf, D.dem_nota_demerito, D.dem_d' +
        'ata, D.dem_responsavel, '
      
        '       D.dem_obs, R.iqf_data, R.iqf_nf, R.iqf_responsavel, R.iqf' +
        '_obs, R.iqf_codfornecedor,'
      
        '       F.forn_nome, C.nome_col as RespRemessa, C1.nome_col as Re' +
        'spDemerito'
      'FROM iqf_demerito D'
      'INNER JOIN iqf_remessa R ON R.iqf_codigo = D.dem_cod_iqf'
      'LEFT JOIN fornecedores F ON F.forn_codigo = R.iqf_codfornecedor'
      'INNER JOIN colaboradores C ON C.codi_col = R.iqf_responsavel'
      'INNER JOIN colaboradores C1 ON C1.codi_col = D.dem_responsavel')
    Params = <>
    Left = 816
    Top = 104
  end
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 896
    Top = 104
    object cdsImprimirdem_codigo: TIntegerField
      FieldName = 'dem_codigo'
      Required = True
    end
    object cdsImprimirdem_cod_iqf: TIntegerField
      FieldName = 'dem_cod_iqf'
    end
    object cdsImprimirdem_nota_demerito: TFloatField
      FieldName = 'dem_nota_demerito'
    end
    object cdsImprimirdem_data: TDateTimeField
      FieldName = 'dem_data'
    end
    object cdsImprimirdem_responsavel: TIntegerField
      FieldName = 'dem_responsavel'
    end
    object cdsImprimirdem_obs: TWideMemoField
      FieldName = 'dem_obs'
      BlobType = ftWideMemo
    end
    object cdsImprimiriqf_data: TDateTimeField
      FieldName = 'iqf_data'
    end
    object cdsImprimiriqf_nf: TWideStringField
      FieldName = 'iqf_nf'
      Size = 200
    end
    object cdsImprimiriqf_responsavel: TLargeintField
      FieldName = 'iqf_responsavel'
    end
    object cdsImprimiriqf_obs: TWideMemoField
      FieldName = 'iqf_obs'
      BlobType = ftWideMemo
    end
    ...
    object cdsImprimirrespremessa: TWideStringField
      FieldName = 'respremessa'
      ReadOnly = True
      Size = 45
    end
    object cdsImprimirrespdemerito: TWideStringField
      FieldName = 'respdemerito'
      ReadOnly = True
      Size = 45
    end
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43573.383395347200000000
    ...
    Datasets = <
      item
        DataSet = frxDBDemerito
        DataSetName = 'frxDBDemerito'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'RELAT'#211'RIO DE DEM'#201'RITO DE REMESSA DE FORNECEDOR')
          ParentFont = False
        end
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo13: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDemerito."iqf_data"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo22: TfrxMemoView
          Left = 217.779840000000000000
          Width = 185.952724170000000000
          Height = 37.795300000000000000
          ShowHint = False
          DataField = 'respremessa'
          DataSet = frxDBDemerito
          DataSetName = 'frxDBDemerito'
          DisplayFormat.DecimalSeparator = ','
          DisplayFormat.FormatStr = '%2.2f'
        ...
        object Memo29: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDemerito."dem_cod_iqf"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo1: TfrxMemoView
          Left = 538.472790000000000000
          Width = 178.393664170000000000
          Height = 37.795300000000000000
          ShowHint = False
          Color = clGradientInactiveCaption
          DataField = 'respdemerito'
          DataSet = frxDBDemerito
          DataSetName = 'frxDBDemerito'
          DisplayFormat.DecimalSeparator = ','
          DisplayFormat.FormatStr = '%2.2f'
        ...
        object Memo3: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDemerito."dem_nota_demerito"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo8: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            'Observa'#231#245'es: [frxDBDemerito."dem_obs"]')
          ParentFont = False
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDemerito."forn_nome"'
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Respons'#225'vel pelo Dem'#233'rito')
          ParentFont = False
          VAlign = vaBottom
        end
  ...
  object frxDBDemerito: TfrxDBDataset
    UserName = 'frxDBDemerito'
    CloseDataSource = False
    FieldAliases.Strings = (
      'dem_codigo=dem_codigo'
      'dem_cod_iqf=dem_cod_iqf'
      'dem_nota_demerito=dem_nota_demerito'
      'dem_data=dem_data'
      'dem_responsavel=dem_responsavel'
      'dem_obs=dem_obs'
      'iqf_data=iqf_data'
      'iqf_nf=iqf_nf'
      ...
      'forn_nome=forn_nome'
      'respremessa=respremessa'
      'respdemerito=respdemerito')
    DataSet = cdsImprimir
    BCDToCurrency = False
    Left = 752
    Top = 104
  ...
  object zqryRespDemerito: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_col, nome_col'
      'FROM Colaboradores'
  ...
  object dspRespDemerito: TDataSetProvider
    DataSet = zqryRespDemerito
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 792
    Top = 232
  end
  object cdsRespDemerito: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspRespDemerito'
    Left = 832
    Top = 232
  ...
  object dsRespDemerito: TDataSource
    DataSet = cdsRespDemerito
    Left = 872
    Top = 232
  end
  ...
  object cdsTemp: TClientDataSet
    ...
    object cdsTempNota: TFloatField
      FieldName = 'Nota'
    end
    object cdsTempCodForn: TIntegerField
      FieldName = 'CodForn'
    end
    object cdsTempConforme: TIntegerField
      FieldName = 'Conforme'
    end
    object cdsTempAvaliacao: TFloatField
      FieldName = 'Avaliacao'
    end
    object cdsTempPontual: TIntegerField
      FieldName = 'Pontual'
    end
  end
