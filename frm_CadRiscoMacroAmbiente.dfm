object FormCadRiscoMacroAmbiente: TFormCadRiscoMacroAmbiente
  Left = 0
  Top = 0
  ...
  object pctMacro: TJvgPageControl
    ...
    object tsCadastro: TTabSheet
      ...
      object dblVariavelExt: TDBLookupComboBox
        Tag = 10
        Left = 15
        Top = 167
        Width = 599
    ...
    object tsPesquisa: TTabSheet
      ...
      object cbbCampo: TComboBox
        ...
        ParentFont = False
        TabOrder = 1
        Text = 'Amea'#231'a/Oportunidade'
        Items.Strings = (
          'Amea'#231'a/Oportunidade')
      end
      object dbgVarExt: TDBGrid
        Left = 5
        Top = 112
        Width = 614
        Height = 331
        ...
        TitleFont.Name = 'Tahoma'
        TitleFont.Style = []
        OnCellClick = dbgVarExtCellClick
        OnDblClick = dbgVarExtDblClick
        Columns = <
          item
            Expanded = False
          ...
          item
            Expanded = False
            FieldName = 'mac_texto'
            Title.Caption = 'Amea'#231'a/Oportunidade'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object dspVarExt: TDataSetProvider
    DataSet = zqryVarExt
  ...
  object cdsVarExt: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspVarExt'
    Left = 144
    Top = 215
    object cdsVarExtvar_codigo: TIntegerField
      FieldName = 'var_codigo'
      Required = True
    end
    object cdsVarExtvar_codfator: TIntegerField
      FieldName = 'var_codfator'
      Required = True
    end
    object cdsVarExtvar_descricao: TWideStringField
      FieldName = 'var_descricao'
      Required = True
      Size = 250
    end
  end
  object dsVarExt: TDataSource
    DataSet = cdsVarExt
    Left = 184
    Top = 215
  end
  ...
  object cdsImprimir: TClientDataSet
    ...
    object cdsImprimirmac_texto: TWideMemoField
      FieldName = 'mac_texto'
      Required = True
      BlobType = ftWideMemo
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42947.714607245400000000
    ...
    Datasets = <
      item
        DataSet = FormCadRiscoAnaliseInterna.frxDBDSAnaliseInterna
  ...
  object zqryMacro: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      
        'SELECT mac_codigo, mac_codfator, mac_codvariavel, mac_tipo, mac_' +
        'texto, mac_processo, mac_probabilidade, mac_consequencia'
      'FROM risco_macro'
      'ORDER BY mac_codigo')
    Params = <>
    Left = 64
  ...
  object dspMacro: TDataSetProvider
    DataSet = zqryMacro
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 104
  ...
  object cdsMacro: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspMacro'
    Left = 144
    Top = 311
    object cdsMacromac_codigo: TIntegerField
      FieldName = 'mac_codigo'
      Required = True
    end
    object cdsMacromac_codfator: TIntegerField
      FieldName = 'mac_codfator'
      Required = True
    end
    object cdsMacromac_codvariavel: TIntegerField
      FieldName = 'mac_codvariavel'
      Required = True
    end
    object cdsMacromac_tipo: TIntegerField
      FieldName = 'mac_tipo'
      Required = True
    end
    object cdsMacromac_processo: TIntegerField
      FieldName = 'mac_processo'
      Required = True
    end
    object cdsMacromac_probabilidade: TIntegerField
      FieldName = 'mac_probabilidade'
    end
    object cdsMacromac_consequencia: TIntegerField
      FieldName = 'mac_consequencia'
    end
    object cdsMacromac_texto: TWideMemoField
      FieldName = 'mac_texto'
      OnGetText = cdsMacromac_textoGetText
      BlobType = ftWideMemo
    end
  end
