object FormCadPlanMudanca: TFormCadPlanMudanca
  Left = 0
  Top = 0
  ...
  object pctProcessos: TJvgPageControl
    ...
    object tsCadastro: TTabSheet
      ...
      object lbl8: TLabel
        ...
        Width = 274
        Height = 13
        Caption = 'Prop'#243'sito das mudan'#231'as e suas potenciais consequ'#234'ncias'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object lbl3: TLabel
        ...
        Width = 162
        Height = 13
        Caption = 'Altera'#231#245'es na integridade do SGQ'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object lbl1: TLabel
        ...
        Width = 129
        Height = 13
        Caption = 'Disponibilidade de recursos'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object lbl4: TLabel
        ...
        Width = 279
        Height = 13
        Caption = 'Aloca'#231#227'o e realoca'#231#227'o de responsabilidades e autoridades'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'Tahoma'
  ...
  object zqryMudanca: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      
        'SELECT clas_pro, codi_pro, entr_pro, func_pro, gest_pro, infr_pr' +
        'o, nome_pro, requ_pro, said_pro, pro_exibelista'
      'FROM processos'
      'ORDER BY nome_pro')
    Params = <>
    Left = 368
  ...
  object dspMudanca: TDataSetProvider
    DataSet = zqryMudanca
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 408
  ...
  object cdsMudanca: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspMudanca'
    Left = 448
    Top = 320
    object lrgntfldMudancaclas_pro: TLargeintField
      FieldName = 'clas_pro'
    end
    object lrgntfldMudancacodi_pro: TLargeintField
      FieldName = 'codi_pro'
      Required = True
    end
    object lrgntfldMudancafunc_pro: TLargeintField
      FieldName = 'func_pro'
    end
    object cdsMudancaentr_pro: TWideMemoField
      FieldName = 'entr_pro'
      BlobType = ftWideMemo
    end
    object lrgntfldMudancagest_pro: TLargeintField
      FieldName = 'gest_pro'
    end
    object cdsMudancainfr_pro: TMemoField
      FieldName = 'infr_pro'
      BlobType = ftMemo
    end
    object cdsMudancanome_pro: TWideStringField
      FieldName = 'nome_pro'
      Size = 45
    end
    object cdsMudancaDescClassificacao: TStringField
      FieldKind = fkLookup
      FieldName = 'DescClassificacao'
      LookupKeyFields = 'codi_com'
      LookupResultField = 'valo_com'
    ...
    object cdsMudancaDescGestor: TStringField
      FieldKind = fkLookup
      FieldName = 'DescGestor'
    ...
    object cdsMudancarequ_pro: TWideMemoField
      FieldName = 'requ_pro'
      BlobType = ftWideMemo
    end
    object cdsMudancasaid_pro: TWideMemoField
      FieldName = 'said_pro'
      BlobType = ftWideMemo
    end
    object cdsMudancapro_exibelista: TWideStringField
      FieldName = 'pro_exibelista'
      Size = 1
    end
  end
  object dsMudanca: TDataSource
    DataSet = cdsMudanca
    Left = 488
    Top = 320
  end
