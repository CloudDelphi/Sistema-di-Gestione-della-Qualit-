object FormPerigos: TFormPerigos
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctLPAR: TJvgPageControl
    Left = 0
    Top = 0
    Width = 787
    Height = 511
    ...
    object tsCadastro: TTabSheet
      ...
      object mmoControle: TMemo
        Left = 7
        Top = 197
        Width = 762
        Height = 103
        TabOrder = 11
        OnKeyPress = mmoControleKeyPress
      end
      object dblTipoAtividade: TDBLookupComboBox
        Left = 7
        Top = 107
        Width = 197
        Height = 26
      ...
      object grp1: TGroupBox
        ...
        object lblSignificativoReav: TLabel
          Left = 265
          Top = 47
          Width = 30
          Height = 18
        ...
        object edtGrauReav: TCurrencyEdit
          Left = 158
          Top = 44
          Width = 80
          Height = 26
        ...
        object dblRespReav: TDBLookupComboBox
          Left = 442
          Top = 44
          Width = 322
          Height = 26
          ...
          KeyField = 'codi_col'
          ListField = 'nome_col'
          ListSource = dsRespReav
          ParentFont = False
          TabOrder = 4
        end
        object edtProbReav: TEdit
          Left = 4
          Top = 43
          Width = 65
          Height = 26
    ...
    object tsImpactos: TTabSheet
      ...
      object dblRisco: TDBLookupComboBox
        Tag = 30
        Left = 7
        Top = 72
        Width = 482
      ...
      object dbgDanos: TDBGrid
        Left = 7
        Top = 104
        Width = 762
        Height = 376
        Hint = 'Selecione o registro para alterar'
        DataSource = dsDanosRiscos
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Tahoma'
        ...
        TitleFont.Style = []
        OnKeyUp = dbgPerigosKeyUp
        Columns = <
          item
            Expanded = False
            FieldName = 'dan_nome'
            Title.Caption = 'Risco/Dano'
    ...
    object tsPesquisa: TTabSheet
      ...
      object dbgPerigos: TDBGrid
        Left = 3
        Top = 60
        Width = 775
        Height = 397
        Hint = 'Duplo clique no registro para visualizar'
        DataSource = dsPerigos
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Tahoma'
        ...
        TitleFont.Name = 'Tahoma'
        TitleFont.Style = []
        OnCellClick = dbgPerigosCellClick
        OnDblClick = dbgPerigosDblClick
        OnKeyUp = dbgPerigosKeyUp
        Columns = <
          item
            Expanded = False
            FieldName = 'lis_numperigo'
            Title.Caption = 'N'#186' Per.'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
          ...
          item
            Expanded = False
            FieldName = 'lis_perigo'
            Title.Caption = 'Perigo'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object zqryPerigos: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      
        'SELECT lis_numperigo, lis_atividade, lis_perigo, lis_tipo_ativid' +
        'ade, '
      
        '       lis_processo, lis_data, lis_probabilidade, lis_gravidade,' +
        ' lis_responsavel, '
      
        '       lis_controle, lis_probabilidade_reav, lis_gravidade_reav,' +
        ' lis_data_reav, '
      '       lis_responsavel_reav, lis_controle_reav'
      'FROM lista_perigos'
      'ORDER BY lis_numperigo')
    Params = <>
    Left = 216
    Top = 240
  end
  object dspPerigos: TDataSetProvider
    DataSet = zqryPerigos
  ...
  object cdsPerigos: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspPerigos'
    Left = 296
    Top = 240
    object cdsPerigoslis_numperigo: TIntegerField
      FieldName = 'lis_numperigo'
      Required = True
    end
    object cdsPerigoslis_atividade: TWideStringField
      FieldName = 'lis_atividade'
      Required = True
      Size = 250
    end
    object cdsPerigoslis_perigo: TWideStringField
      FieldName = 'lis_perigo'
      Size = 250
    end
    object cdsPerigoslis_tipo_atividade: TIntegerField
      FieldName = 'lis_tipo_atividade'
    end
    object cdsPerigoslis_processo: TIntegerField
      FieldName = 'lis_processo'
    end
    object cdsPerigoslis_data: TDateTimeField
      FieldName = 'lis_data'
    end
    object cdsPerigoslis_probabilidade: TIntegerField
      FieldName = 'lis_probabilidade'
    end
    object cdsPerigoslis_gravidade: TIntegerField
      FieldName = 'lis_gravidade'
    end
    object cdsPerigoslis_responsavel: TIntegerField
      FieldName = 'lis_responsavel'
    end
    object cdsPerigoslis_controle: TWideMemoField
      FieldName = 'lis_controle'
      BlobType = ftWideMemo
    end
    object cdsPerigoslis_probabilidade_reav: TIntegerField
      FieldName = 'lis_probabilidade_reav'
    end
    object cdsPerigoslis_gravidade_reav: TIntegerField
      FieldName = 'lis_gravidade_reav'
    end
    object cdsPerigoslis_data_reav: TDateTimeField
      FieldName = 'lis_data_reav'
    end
    object cdsPerigoslis_responsavel_reav: TIntegerField
      FieldName = 'lis_responsavel_reav'
    end
    object cdsPerigoslis_controle_reav: TWideMemoField
      FieldName = 'lis_controle_reav'
      BlobType = ftWideMemo
    end
  end
  object dsPerigos: TDataSource
    DataSet = cdsPerigos
    Left = 336
    Top = 240
  end
  ...
  object cdsResp: TClientDataSet
    ...
    Left = 112
    Top = 224
    object cdsRespcodi_col: TLargeintField
      FieldName = 'codi_col'
      Required = True
    end
    object cdsRespnome_col: TWideStringField
      FieldName = 'nome_col'
      Size = 45
    end
  end
  ...
  object zqryDanos: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT dan_codigo, dan_nome, dan_descricao'
      'FROM danos'
      'ORDER BY dan_nome')
    Params = <>
    Left = 32
  ...
  object dspDanos: TDataSetProvider
    DataSet = zqryDanos
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 72
  ...
  object cdsDanos: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspDanos'
    Left = 112
    Top = 272
    object cdsDanosdan_codigo: TIntegerField
      FieldName = 'dan_codigo'
      Required = True
    end
    object cdsDanosdan_nome: TWideStringField
      FieldName = 'dan_nome'
      Required = True
      Size = 250
    end
    object cdsDanosdan_descricao: TWideMemoField
      FieldName = 'dan_descricao'
      BlobType = ftWideMemo
    end
  end
  object dsDanos: TDataSource
    DataSet = cdsDanos
    Left = 152
    Top = 272
  end
  object zqryTipoAtividade: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
  ...
  object cdsTipoAtividade: TClientDataSet
    ...
    Left = 696
    Top = 272
    object cdsTipoAtividadecodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    object cdsTipoAtividadevalo_com: TWideStringField
      FieldName = 'valo_com'
      Size = 50
    end
  end
  object dsTipoAtividade: TDataSource
    DataSet = cdsTipoAtividade
    Left = 736
    Top = 272
  end
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
      ...
      'lis_processo, lis_data, lis_probabilidade, lis_gravidade,'
        ...
        'lis_responsavel, lis_controle, lis_probabilidade_reav, lis_gravi' +
        'dade_reav, '
  ...
  object cdsImprimir: TClientDataSet
    ...
    object cdsImprimirGrauPerigo: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'GrauPerigo'
      Calculated = True
    end
    ...
    object cdsImprimirlis_numperigo: TIntegerField
      FieldName = 'lis_numperigo'
      Required = True
    end
    object cdsImprimirlis_atividade: TWideStringField
      FieldName = 'lis_atividade'
      Required = True
      Size = 250
    end
    object cdsImprimirlis_perigo: TWideStringField
      FieldName = 'lis_perigo'
      Size = 250
    end
    object cdsImprimirlis_tipo_atividade: TIntegerField
      FieldName = 'lis_tipo_atividade'
    end
    object cdsImprimirlis_processo: TIntegerField
      FieldName = 'lis_processo'
    end
    object cdsImprimirlis_data: TDateTimeField
      FieldName = 'lis_data'
    end
    object cdsImprimirlis_probabilidade: TIntegerField
      FieldName = 'lis_probabilidade'
    end
    object cdsImprimirlis_gravidade: TIntegerField
      FieldName = 'lis_gravidade'
    end
    object cdsImprimirlis_responsavel: TIntegerField
      FieldName = 'lis_responsavel'
    end
    object cdsImprimirlis_controle: TWideMemoField
      FieldName = 'lis_controle'
      BlobType = ftWideMemo
    end
    object cdsImprimirlis_probabilidade_reav: TIntegerField
      FieldName = 'lis_probabilidade_reav'
    end
    object cdsImprimirlis_gravidade_reav: TIntegerField
      FieldName = 'lis_gravidade_reav'
    end
    object cdsImprimirlis_data_reav: TDateTimeField
      FieldName = 'lis_data_reav'
    end
    object cdsImprimirlis_responsavel_reav: TIntegerField
      FieldName = 'lis_responsavel_reav'
    end
    object cdsImprimirlis_controle_reav: TWideMemoField
      FieldName = 'lis_controle_reav'
      BlobType = ftWideMemo
    end
    ...
    object cdsImprimirTipoAtividade: TStringField
      FieldKind = fkLookup
      FieldName = 'TipoAtividade'
      LookupDataSet = cdsTipoAtividade
      LookupKeyFields = 'codi_com'
      LookupResultField = 'valo_com'
      KeyFields = 'lis_tipo_atividade'
      Lookup = True
    end
    object cdsImprimirResponsavel: TStringField
      FieldKind = fkLookup
      FieldName = 'Responsavel'
      LookupDataSet = cdsResp
      LookupKeyFields = 'codi_col'
      LookupResultField = 'nome_col'
      KeyFields = 'lis_responsavel'
      Size = 100
      Lookup = True
    end
    object cdsImprimirSignificativoReav: TStringField
      FieldKind = fkCalculated
      FieldName = 'SignificativoReav'
      Size = 3
      Calculated = True
    end
    object cdsImprimirGrauPerigoReav: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'GrauPerigoReav'
      Calculated = True
    end
  end
  object zqryLeis: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT lis_numperigo, lir_identificacao'
  ...
  object cdsLeis: TClientDataSet
    ...
    object cdsLeislis_numperigo: TIntegerField
      FieldName = 'lis_numperigo'
      Required = True
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42720.440146840280000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'LISTA DE PERIGOS E AVALIA'#199#195'O DOS RISCOS')
          ParentFont = False
        end
        ...
        object Memo14: TfrxMemoView
          Left = 161.110236220000000000
          Top = 69.921259840000000000
          Width = 136.062933540000000000
          Height = 94.488188980000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo24: TfrxMemoView
          Left = 610.732840000000000000
          Top = 70.031540000000010000
          Width = 163.275590551181000000
          Height = 94.488188980000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo18: TfrxMemoView
          Left = 886.866730000000000000
          Top = 70.031540000000010000
          Width = 154.960678740000000000
          Height = 94.488188980000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo19: TfrxMemoView
          Left = 773.906000000000000000
          Top = 47.456710000000000000
          Width = 268.346456690000000000
          Height = 22.677118980000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo29: TfrxMemoView
          Width = 37.417308190000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_numperigo'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."lis_numperigo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo30: TfrxMemoView
          Left = 36.874057240000000000
          Width = 124.724343540000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_atividade'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBDSLPAR."lis_atividade"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo31: TfrxMemoView
          Left = 161.173228350000000000
          Width = 136.062933540000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_perigo'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBDSLPAR."lis_perigo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo32: TfrxMemoView
          Left = 354.323347240000000000
          Width = 52.913322360000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_data'
          DataSet = frxDBDSLPAR
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."lis_data"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo33: TfrxMemoView
          Left = 407.267716540000000000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."Responsavel"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo34: TfrxMemoView
          Left = 297.047527240000000000
          Width = 56.692803540000000000
          Height = 60.472480000000000000
          ShowHint = False
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."TipoAtividade"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo36: TfrxMemoView
          Left = 497.952755910000000000
          Width = 22.677165350000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_probabilidade'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."lis_probabilidade"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo37: TfrxMemoView
          Left = 520.629921260000000000
          Width = 22.677165350000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_gravidade'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."lis_gravidade"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo38: TfrxMemoView
          Left = 543.307086610000000000
          Width = 22.677165350000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'GrauPerigo'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."GrauPerigo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo39: TfrxMemoView
          Left = 565.984251970000000000
          Width = 45.354308740000000000
          Height = 60.472480000000000000
          ShowHint = False
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."Significativo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo40: TfrxMemoView
          Left = 611.598425200000000000
          Width = 162.519685039370000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_controle'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object Memo20: TfrxMemoView
          ...
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_probabilidade_reav'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."lis_probabilidade_reav"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo22: TfrxMemoView
          Left = 796.583165350000000000
          Width = 22.677165350000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_gravidade_reav'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."lis_gravidade_reav"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo25: TfrxMemoView
          Left = 819.260330700000000000
          Width = 22.677165350000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'GrauPerigoReav'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."GrauPerigoReav"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo27: TfrxMemoView
          Left = 841.937496060000000000
          Width = 45.354308740000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'SignificativoReav'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLPAR."SignificativoReav"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo28: TfrxMemoView
          Left = 887.551669290000000000
          Width = 154.204707320000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lis_controle_reav'
          DataSet = frxDBDSLPAR
          DataSetName = 'frxDBDSLPAR'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
      ...
      object Processo: TfrxGroupHeader
        ...
        Width = 1046.929810000000000000
        Condition = 'frxDBDSLPAR."nome_pro"'
  ...
  object frxDBDSLPAR: TfrxDBDataset
    UserName = 'frxDBDSLPAR'
    CloseDataSource = False
    FieldAliases.Strings = (
      'DescProbabilidade=DescProbabilidade'
      'GrauPerigo=GrauPerigo'
      'Significativo=Significativo'
      'lis_numperigo=lis_numperigo'
      'lis_atividade=lis_atividade'
      'lis_perigo=lis_perigo'
      'lis_tipo_atividade=lis_tipo_atividade'
      'lis_processo=lis_processo'
      'lis_data=lis_data'
      'lis_probabilidade=lis_probabilidade'
      'lis_gravidade=lis_gravidade'
      'lis_responsavel=lis_responsavel'
      'lis_controle=lis_controle'
      'lis_probabilidade_reav=lis_probabilidade_reav'
      'lis_gravidade_reav=lis_gravidade_reav'
      'lis_data_reav=lis_data_reav'
      'lis_responsavel_reav=lis_responsavel_reav'
      'lis_controle_reav=lis_controle_reav'
      'nome_pro=nome_pro'
      'TipoAtividade=TipoAtividade'
      'Responsavel=Responsavel'
      'SignificativoReav=SignificativoReav'
      'GrauPerigoReav=GrauPerigoReav')
    DataSet = cdsImprimir
    BCDToCurrency = False
    Left = 576
    Top = 144
  ...
  object dspRespReav: TDataSetProvider
    DataSet = zqryRespReav
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 488
    Top = 424
  end
  object cdsRespReav: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspRespReav'
    Left = 528
    Top = 424
  ...
  object dsRespReav: TDataSource
    DataSet = cdsRespReav
    Left = 568
    Top = 424
  end
  object zqryDanosRiscos: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT L.lis_numperigo, L.lis_numdano, D.dan_nome'
  ...
  object dspDanosRiscos: TDataSetProvider
    DataSet = zqryDanosRiscos
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 72
    Top = 320
  end
  object cdsDanosRiscos: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspDanosRiscos'
    Left = 112
    Top = 320
    object cdsDanosRiscoslis_numdano: TIntegerField
      FieldName = 'lis_numdano'
      Required = True
    end
    object cdsDanosRiscoslis_numperigo: TIntegerField
      FieldName = 'lis_numperigo'
      Required = True
    end
    object cdsDanosRiscosdan_nome: TWideStringField
      FieldName = 'dan_nome'
      Required = True
      Size = 250
    end
  end
  object dsDanosRiscos: TDataSource
    DataSet = cdsDanosRiscos
    Left = 152
    Top = 320
  end
end
