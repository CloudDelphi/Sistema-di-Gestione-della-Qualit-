object FormPesqTreinamentos: TFormPesqTreinamentos
  Left = 0
  Top = 0
  ...
  object pctTreinamentos: TJvgPageControl
    Left = 0
    Top = 0
    Width = 580
    Height = 393
    ActivePage = tsColaborador
    Align = alClient
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    ...
    object tsTreinamento: TTabSheet
      Caption = 'Por Treinamento'
      object lbl1: TLabel
        Left = 8
        Top = 9
        Width = 60
      ...
      object dblTreinamento: TDBLookupComboBox
        ...
        ParentFont = False
        TabOrder = 2
        OnCloseUp = dblTreinamentoCloseUp
      end
      object rgOpcoesTre: TRadioGroup
        Left = 8
        Top = 55
        Width = 560
        Height = 49
        ...
        Items.Strings = (
          ...
          'Todos')
        TabOrder = 3
        OnClick = rgOpcoesTreClick
      end
    end
    object tsColaborador: TTabSheet
      Caption = 'Por Colaborador'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Tahoma'
      ...
      object rgOpcoesCol: TRadioGroup
        Left = 8
        Top = 55
        Width = 560
        Height = 49
  ...
  object zqryColab: TZQuery
    ...
    SQL.Strings = (
      'SELECT C.nome_col, CT.dtpr_tre, CT.dtre_tre'
  ...
  object cdsColab: TClientDataSet
    ...
    object cdsColabdtpr_tre: TDateTimeField
      FieldName = 'dtpr_tre'
      OnGetText = cdsColabdtpr_treGetText
    end
    object cdsColabdtre_tre: TDateTimeField
      FieldName = 'dtre_tre'
      OnGetText = cdsColabdtre_treGetText
    end
  end
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT C.nome_col, CT.codi_tre, CT.dtpr_tre, CT.dtre_tre, T.desc' +
        '_tre'
      'FROM colab_treinamentos CT'
      'INNER JOIN colaboradores C ON C.codi_col = CT.codi_col'
  ...
  object cdsImprimir: TClientDataSet
    ...
    object cdsImprimirdtpr_tre: TDateTimeField
      FieldName = 'dtpr_tre'
      OnGetText = cdsImprimirdtpr_treGetText
    end
    object cdsImprimirdtre_tre: TDateTimeField
      FieldName = 'dtre_tre'
      OnGetText = cdsImprimirdtre_treGetText
    end
    object cdsImprimircodi_tre: TLargeintField
      FieldName = 'codi_tre'
      Required = True
    end
    object cdsImprimirdesc_tre: TWideStringField
      FieldName = 'desc_tre'
      Required = True
      Size = 120
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42929.687169386570000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSColab
        DataSetName = 'frxDBDSColab'
      end>
    Variables = <
      item
        Name = ' Relat'#243'rio'
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'LISTA DE TREINAMENTOS POR COLABORADORES')
          ParentFont = False
        end
      ...
      object Detalhe: TfrxMasterData
        ...
        object frxControleDATA: TfrxMemoView
          ...
          Memo.UTF8W = (
            '[frxDBDSColab."desc_tre"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo10: TfrxMemoView
          Left = 536.582677170000000000
          Width = 91.464537640000000000
          Height = 30.236240000000000000
          ShowHint = False
          DataField = 'dtpr_tre'
          DataSet = frxDBDSColab
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSColab."dtpr_tre"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo3: TfrxMemoView
          Left = 628.645950000000000000
      ...
      object GroupHeader1: TfrxGroupHeader
        Height = 52.952782760000000000
        Top = 151.181200000000000000
        Width = 718.110700000000000000
        Condition = '<frxDBDSColab."nome_col">'
        StartNewPage = True
        object Memo6: TfrxMemoView
          Top = 34.055132759999990000
          Width = 536.315248660001000000
          Height = 18.897650000000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo5: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            'Colaborador: [frxDBDSColab."nome_col"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object frxDBTreinamentos: TfrxDBDataset
    UserName = 'frxDBTreinamentos'
  ...
  object zqryTrein: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT T.desc_tre, CT.dtpr_tre, CT.dtre_tre'
      'FROM colab_treinamentos CT'
      'INNER JOIN treinamentos T ON T.codi_tre = CT.codi_tre')
    Params = <>
    Left = 136
  ...
  object dspTrein: TDataSetProvider
    DataSet = zqryTrein
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 168
  ...
  object cdsTrein: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspTrein'
    Left = 208
    Top = 208
    object cdsTreindesc_tre: TWideStringField
      FieldName = 'desc_tre'
      Required = True
      Size = 120
    end
    object cdsTreindtpr_tre: TDateTimeField
      FieldName = 'dtpr_tre'
    end
    object cdsTreindtre_tre: TDateTimeField
      FieldName = 'dtre_tre'
    end
  end
  object dsTrein: TDataSource
    DataSet = cdsTrein
    Left = 248
    Top = 208
  end
  object frxDBDSColab: TfrxDBDataset
    UserName = 'frxDBDSColab'
    CloseDataSource = False
    FieldAliases.Strings = (
      'nome_col=nome_col'
      'dtpr_tre=dtpr_tre'
      ...
      'codi_tre=codi_tre'
      'desc_tre=desc_tre')
    DataSet = cdsImprimirColab
    BCDToCurrency = False
    Left = 408
    Top = 208
  end
  object zqryImprimirColab: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
  ...
  object dspImprimirColab: TDataSetProvider
    DataSet = zqryImprimirColab
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 488
    Top = 208
  end
  object cdsImprimirColab: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspImprimirColab'
    Left = 528
    Top = 208
