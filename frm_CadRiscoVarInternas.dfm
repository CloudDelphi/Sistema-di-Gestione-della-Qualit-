object FormCadRiscoVarInternas: TFormCadRiscoVarInternas
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Vari'#225'veis Internas (An'#225'lise de Risco)'
  ClientHeight = 401
  ClientWidth = 658
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctVarInt: TJvgPageControl
    Left = 0
    Top = 0
    Width = 658
    Height = 329
    ...
    object tsCadastro: TTabSheet
      ...
      object dblFator: TDBLookupComboBox
        ...
        KeyField = 'codi_com'
        ListField = 'valo_com'
        ListSource = dsFatoresInt
        ParentFont = False
        TabOrder = 2
      end
      object mmoVariavelInt: TMemo
        Left = 15
        Top = 114
        Width = 632
        Height = 131
    ...
    object tsPesquisa: TTabSheet
      ...
      object cbbCampo: TComboBox
        ...
        ParentFont = False
        TabOrder = 1
        Text = 'Vari'#225'vel Interna'
        Items.Strings = (
          'Vari'#225'vel Interna')
      end
      object dbgVarInt: TDBGrid
        Left = 5
        Top = 62
        Width = 644
        Height = 236
        ...
        TitleFont.Style = []
        OnCellClick = dbgVarIntCellClick
        OnDblClick = dbgVarIntDblClick
        Columns = <
          item
            Expanded = False
          ...
          item
            ...
            Title.Caption = 'Vari'#225'vel Interna'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object cdsVarInt: TClientDataSet
    ...
    object cdsVarIntfator: TWideStringField
      FieldName = 'fator'
      Size = 50
    end
  end
  ...
  object frxDBDSVarInt: TfrxDBDataset
    UserName = 'frxDBDSVarInt'
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42101.653578437500000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSVarInt
        DataSetName = 'frxDBDSVarInt'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Titulo: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'LISTAGEM DE VARI'#193'VEIS INTERNAS (AN'#193'LISE DE RISCO)')
          ParentFont = False
        end
  ...
  object dspFatoresInt: TDataSetProvider
    DataSet = zqryFatoresInt
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 104
    Top = 167
  end
  object cdsFatoresInt: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspFatoresInt'
    Left = 144
    Top = 167
    object cdsFatoresIntcodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    object cdsFatoresIntvalo_com: TWideStringField
      FieldName = 'valo_com'
      Size = 50
    end
  end
  object dsFatoresInt: TDataSource
    DataSet = cdsFatoresInt
    Left = 184
    Top = 167
  end
end
