object FormCadModoRecuperacao: TFormCadModoRecuperacao
  Left = 0
  Top = 0
  ...
  object pctTreinamentos: TJvgPageControl
    ...
    object tsPesquisa: TTabSheet
      ...
      object cbbCampo: TComboBox
        ...
        ParentFont = False
        TabOrder = 1
        Text = 'Modo de Recupera'#231#227'o'
        Items.Strings = (
  ...
  object dspModoRecup: TDataSetProvider
    DataSet = zqryModoRecup
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 104
    Top = 215
  end
  object cdsModoRecup: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspModoRecup'
    Left = 144
    Top = 215
    object cdsModoRecuptipo_com: TLargeintField
      FieldName = 'tipo_com'
      Required = True
    end
    object cdsModoRecupdesc_com: TWideStringField
      FieldName = 'desc_com'
      Required = True
      Size = 50
    end
    object cdsModoRecupcodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    object cdsModoRecupvalo_com: TWideStringField
      FieldName = 'valo_com'
      Size = 50
    end
    object cdsModoRecuporde_com: TLargeintField
      FieldName = 'orde_com'
      Required = True
    end
  end
  object dsModoRecup: TDataSource
    DataSet = cdsModoRecup
    Left = 184
    Top = 215
  end
  ...
  object frxDBDSModoRecup: TfrxDBDataset
    UserName = 'frxDBDSModoRecup'
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42237.473209768520000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSModoRecup
        DataSetName = 'frxDBDSModoRecup'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Titulo: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'LISTAGEM DE MODOS DE RECUPERA'#199#195'O DE DOCUMENTOS')
          ParentFont = False
        end
