object FormCadMotivoRNC: TFormCadMotivoRNC
  Left = 0
  Top = 0
  ...
  object pctTreinamentos: TJvgPageControl
    ...
    TabOrder = 0
    TabStop = False
    OnChange = pctTreinamentosChange
      ...
      object dbgTreinamentos: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'valo_com'
            Title.Caption = 'Modo de Recupera'#231#227'o'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object zqryMotivo: TZQuery
    ...
    SQL.Strings = (
      'SELECT tipo_com, desc_com, codi_com, valo_com, orde_com'
      'FROM tabela_combos'
      'WHERE tipo_com = 32'
      'ORDER BY codi_com')
    Params = <>
  ...
  object cdsMotivo: TClientDataSet
    ...
    Left = 144
    Top = 215
    object cdsMotivotipo_com: TLargeintField
      FieldName = 'tipo_com'
      Required = True
    end
    object cdsMotivodesc_com: TWideStringField
      FieldName = 'desc_com'
      Required = True
      Size = 50
    end
    ...
    object cdsMotivoorde_com: TLargeintField
      FieldName = 'orde_com'
      Required = True
    end
  end
  ...
  object frxDBDSTabelaCombos: TfrxDBDataset
    UserName = 'frxDBDSTabelaCombos'
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 440
    Top = 216
    object cdsImprimirtipo_com: TLargeintField
      FieldName = 'tipo_com'
      Required = True
    end
    object cdsImprimirdesc_com: TWideStringField
      FieldName = 'desc_com'
      Required = True
      Size = 50
    end
    object cdsImprimircodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    ...
    object cdsImprimirorde_com: TLargeintField
      FieldName = 'orde_com'
      Required = True
    end
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43306.484056446760000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSTabelaCombos
        DataSetName = 'frxDBDSTabelaCombos'
      end>
    Variables = <
      item
        Name = ' New Category1'
  ...
  object zqryProcMot: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT mot_motivo, mot_processo, P.nome_pro as NomeProcesso'
  ...
  object dspProcMot: TDataSetProvider
    DataSet = zqryProcMot
    Options = [poAutoRefresh, poAllowCommandText]
    Left = 504
    Top = 88
  end
  object cdsProcMot: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspProcMot'
    Left = 544
    Top = 88
    object cdsProcMotmot_motivo: TIntegerField
      FieldName = 'mot_motivo'
      Required = True
    end
    object cdsProcMotmot_processo: TIntegerField
      FieldName = 'mot_processo'
      Required = True
    end
    object cdsProcMotnomeprocesso: TWideStringField
      FieldName = 'nomeprocesso'
      ReadOnly = True
      Size = 45
    end
  end
  object dsProcMot: TDataSource
    DataSet = cdsProcMot
    Left = 584
    Top = 88
  end
