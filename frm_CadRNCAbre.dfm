object FormCadRNCAbre: TFormCadRNCAbre
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctAbreRNC: TJvgPageControl
    Left = 0
    Top = 0
    Width = 757
    Height = 459
    ...
    object tsCadastro: TTabSheet
      ...
      object dblRelacionamento: TDBLookupComboBox
        Left = 7
        Top = 395
        Width = 177
        Height = 26
    ...
    object tsDocumentos: TTabSheet
      ...
      object edtIdentificacaoDoc: TEdit
        Tag = 30
        Left = 7
        Top = 27
        Width = 101
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT rnc_codigo, rnc_identificacao, rnc_data, rnc_emitido, rnc' +
        '_motivo, '
      
        'rnc_processo, rnc_setor, rnc_origem, TC1.valo_com as Origem, rnc' +
        '_cliente, CL.cli_nome, '
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 568
    Top = 144
    object cdsImprimirrnc_codigo: TIntegerField
      FieldName = 'rnc_codigo'
      Required = True
    end
    object cdsImprimirrnc_identificacao: TWideStringField
      FieldName = 'rnc_identificacao'
      Required = True
      Size = 7
    end
    object cdsImprimirrnc_data: TDateTimeField
      FieldName = 'rnc_data'
    end
    object cdsImprimirrnc_emitido: TIntegerField
      FieldName = 'rnc_emitido'
    end
    object cdsImprimirrnc_motivo: TIntegerField
      FieldName = 'rnc_motivo'
    end
    object cdsImprimirrnc_processo: TIntegerField
      FieldName = 'rnc_processo'
    end
    object cdsImprimirrnc_setor: TWideStringField
      FieldName = 'rnc_setor'
      Size = 25
    end
    object cdsImprimirrnc_origem: TIntegerField
      FieldName = 'rnc_origem'
    end
    object cdsImprimirrnc_cliente: TIntegerField
      FieldName = 'rnc_cliente'
    end
    object cdsImprimirrnc_fornecedor: TIntegerField
      FieldName = 'rnc_fornecedor'
    end
    object cdsImprimirrnc_consumidor: TWideStringField
      FieldName = 'rnc_consumidor'
      Size = 60
    end
    object cdsImprimirrnc_nconformidade: TWideMemoField
      FieldName = 'rnc_nconformidade'
      BlobType = ftWideMemo
    end
    object cdsImprimirrnc_procede: TIntegerField
      FieldName = 'rnc_procede'
    end
    object cdsImprimirrnc_responsavel: TIntegerField
      FieldName = 'rnc_responsavel'
    end
    object cdsImprimirrnc_departamento: TWideStringField
      FieldName = 'rnc_departamento'
      Size = 25
    end
    object cdsImprimirrnc_relacionamento: TIntegerField
      FieldName = 'rnc_relacionamento'
    end
    object cdsImprimirrnc_representante: TWideStringField
      FieldName = 'rnc_representante'
      Size = 25
    end
    object cdsImprimiremitido: TWideStringField
      FieldName = 'emitido'
      ReadOnly = True
      Size = 45
    end
    object cdsImprimirmotivo: TWideStringField
      FieldName = 'motivo'
      ReadOnly = True
      Size = 50
    end
  ...
  object frxDBRNC: TfrxDBDataset
    UserName = 'frxDBRNC'
    CloseDataSource = False
    FieldAliases.Strings = (
      'rnc_codigo=rnc_codigo'
      'rnc_identificacao=rnc_identificacao'
      'rnc_data=rnc_data'
      'rnc_emitido=rnc_emitido'
      'rnc_motivo=rnc_motivo'
      'rnc_processo=rnc_processo'
      'rnc_setor=rnc_setor'
      'rnc_origem=rnc_origem'
      'rnc_cliente=rnc_cliente'
      'rnc_fornecedor=rnc_fornecedor'
      'rnc_consumidor=rnc_consumidor'
      'rnc_nconformidade=rnc_nconformidade'
      'rnc_procede=rnc_procede'
      'rnc_responsavel=rnc_responsavel'
      'rnc_departamento=rnc_departamento'
      'rnc_relacionamento=rnc_relacionamento'
      'rnc_representante=rnc_representante'
      'emitido=emitido'
      'motivo=motivo'
      'cli_nome=cli_nome'
      'forn_nome=forn_nome'
  ...
  object cdsMotivo: TClientDataSet
    ...
    Left = 448
    Top = 376
    object cdsMotivocodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    object cdsMotivovalo_com: TWideStringField
      FieldName = 'valo_com'
      Size = 50
    end
  end
  ...
  object zqryRelacionamento: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_com, valo_com FROM tabela_combos')
    Params = <>
  ...
  object zqryDocs: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT rnc_codigo, doc_codigo, doc_descricao, doc_caminho'
      'FROM rnc_documentos')
    Params = <>
    Left = 568
    Top = 224
  ...
  object cdsDocs: TClientDataSet
    ...
    Left = 648
    Top = 224
    object cdsDocsrnc_codigo: TIntegerField
      FieldName = 'rnc_codigo'
      Required = True
    end
    object cdsDocsdoc_codigo: TIntegerField
      FieldName = 'doc_codigo'
      Required = True
    end
    object cdsDocsdoc_descricao: TWideMemoField
      FieldName = 'doc_descricao'
      OnGetText = cdsDocsdoc_descricaoGetText
      BlobType = ftWideMemo
    end
    object cdsDocsdoc_caminho: TWideMemoField
