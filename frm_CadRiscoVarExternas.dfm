object FormCadRiscoVarExternas: TFormCadRiscoVarExternas
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Vari'#225'veis Externas (An'#225'lise de Risco)'
  ClientHeight = 401
  ClientWidth = 716
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctVarExt: TJvgPageControl
    Left = 0
    Top = 0
    Width = 716
    Height = 329
    ...
    object tsPesquisa: TTabSheet
      ...
      object cbbCampo: TComboBox
        ...
        ParentFont = False
        TabOrder = 1
        Text = 'Vari'#225'vel Externa'
        Items.Strings = (
          'Vari'#225'vel Externa')
      end
      object dbgVarExt: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Vari'#225'vel Externa'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object zqryVarExt: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT var_codigo, var_codfator, var_descricao, TC.valo_com as f' +
        'ator'
      'FROM risco_variaveis_ext R'
      
        'INNER JOIN tabela_combos TC ON TC.codi_com = R.var_codfator AND ' +
        'TC.tipo_com = 22')
    Params = <>
    Left = 64
    Top = 215
  ...
  object cdsVarExt: TClientDataSet
    ...
    object cdsVarExtfator: TWideStringField
      FieldName = 'fator'
      Size = 50
    end
  end
  ...
  object frxDBDSVarExt: TfrxDBDataset
    UserName = 'frxDBDSVarExt'
    CloseDataSource = False
    FieldAliases.Strings = (
      'var_codigo=var_codigo'
      'var_codfator=var_codfator'
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT var_codigo, var_codfator, TC.valo_com as Fator, var_descr' +
        'icao'
      'FROM risco_variaveis_ext R'
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 440
    Top = 216
    object cdsImprimirvar_codigo: TIntegerField
      FieldName = 'var_codigo'
      Required = True
    end
    object cdsImprimirvar_codfator: TIntegerField
      FieldName = 'var_codfator'
      Required = True
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42101.654525798620000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSVarExt
        DataSetName = 'frxDBDSVarExt'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Titulo: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'LISTAGEM DE VARI'#193'VEIS EXTERNAS (AN'#193'LISE DE RISCO)')
          ParentFont = False
        end
      ...
      object Detalhe: TfrxMasterData
        ...
        object frxControleDATA: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSVarExt."var_codigo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo2: TfrxMemoView
          Left = 55.834645670000000000
          Width = 661.795275590551000000
          Height = 37.795300000000000000
          ShowHint = False
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBDSVarExt."fator"'
        object Memo15: TfrxMemoView
          Top = 7.000000000000000000
          Width = 56.314960629921300000
          Height = 18.897650000000000000
          ShowHint = False
          Color = cl3DLight
          DisplayFormat.DecimalSeparator = ','
        ...
        object Memo1: TfrxMemoView
          Left = 55.866420000000000000
          Top = 26.031540000000010000
          Width = 661.795275590000000000
          Height = 18.897650000000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
