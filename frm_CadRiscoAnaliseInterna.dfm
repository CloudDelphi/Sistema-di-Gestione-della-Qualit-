object FormCadRiscoAnaliseInterna: TFormCadRiscoAnaliseInterna
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctAnaliseInt: TJvgPageControl
    Left = 0
    Top = 0
    Width = 579
    Height = 475
    ...
    object tsCadastro: TTabSheet
      ...
      object dblFator: TDBLookupComboBox
        Left = 15
        Top = 113
        Width = 549
        Height = 26
        ...
        KeyField = 'codi_com'
        ListField = 'valo_com'
        ListSource = dsFatoresExt
        ParentFont = False
        TabOrder = 2
        OnCloseUp = dblFatorCloseUp
      end
      ...
      object dblVariavelInt: TDBLookupComboBox
        Left = 15
        Top = 161
        Width = 549
        Height = 26
      ...
      object dblProbabilidade: TDBLookupComboBox
        Left = 15
        Top = 414
        Width = 136
        Height = 26
        ...
        KeyField = 'codi_com'
        ListField = 'valo_com'
        ListSource = dsProbabilidade
        ParentFont = False
        TabOrder = 7
        OnCloseUp = dblProbabilidadeCloseUp
      end
      object dblConsequencia: TDBLookupComboBox
        Left = 158
        Top = 414
        Width = 152
        Height = 26
    ...
    object tsHistorico: TTabSheet
      ...
      object dblFatorHist: TDBLookupComboBox
        Left = 15
        Top = 113
        Width = 549
        Height = 26
      ...
      object dblVariavelHist: TDBLookupComboBox
        Left = 15
        Top = 161
        Width = 549
        Height = 26
      ...
      object dblProcessoHist: TDBLookupComboBox
        Left = 15
        Top = 70
        Width = 549
        Height = 26
      ...
      object dbgHistorico: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Consequ'#234'ncia'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
    ...
    object tsPesquisa: TTabSheet
      ...
      object cbbCampo: TComboBox
        ...
        ParentFont = False
        TabOrder = 1
        Text = 'Ponto Forte/Ponto Fraco'
        Items.Strings = (
          'Ponto Forte/Ponto Fraco')
      end
      object dbgAnaliseInt: TDBGrid
        Left = 5
        Top = 107
        Width = 557
        Height = 336
        Hint = 'Selecione o registro para alterar'
        DataSource = dsAnaliseInt
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Tahoma'
        ...
        TitleFont.Name = 'Tahoma'
        TitleFont.Style = []
        OnCellClick = dbgAnaliseIntCellClick
        OnDblClick = dbgAnaliseIntDblClick
        Columns = <
          item
            Expanded = False
          ...
          item
            Expanded = False
            FieldName = 'int_texto'
            Title.Caption = 'Ponto Forte/Ponto Fraco'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
      ...
      object pnlFiltroProcesso: TPanel
        ...
        object chkFiltroProc: TCheckBox
          Tag = 30
          Left = 508
          Top = 17
          Width = 57
        ...
        object dblFiltroProcesso: TDBLookupComboBox
          ...
          KeyField = 'codi_pro'
          ListField = 'nome_pro'
          ListSource = dsProcessoFiltro
          ParentFont = False
          TabOrder = 1
          OnCloseUp = dblFiltroProcessoCloseUp
        end
      end
    end
  end
  ...
  object pnlImprimir: TPanel
    ...
    object dblFatorImp: TDBLookupComboBox
      Left = 13
      Top = 148
      Width = 345
      Height = 26
      ...
      KeyField = 'codi_com'
      ListField = 'valo_com'
      ListSource = dsFatoresImp
      ParentFont = False
      TabOrder = 3
      OnCloseUp = dblFatorCloseUp
    end
    object chkTodosFator: TCheckBox
      Left = 364
      Top = 150
      Width = 59
      Height = 17
  ...
  object pnlTexto: TPanel
    ...
    object pnl4: TPanel
      ...
      object btnSairTexto: TBitBtn
        ...
        ShowHint = True
        TabOrder = 0
        OnClick = btnSairTextoClick
      end
    end
    object mmoTextoConsulta: TMemo
      Left = 1
      Top = 64
      Width = 420
      Height = 183
  ...
  object zqryVarInt: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT var_codigo, var_codfator, var_descricao'
      'FROM risco_variaveis_int')
    Params = <>
    Left = 64
    Top = 215
  end
  object dspVarInt: TDataSetProvider
    DataSet = zqryVarInt
  ...
  object cdsVarInt: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspVarInt'
    Left = 144
    Top = 215
    object cdsVarIntvar_codigo: TIntegerField
      FieldName = 'var_codigo'
      Required = True
    end
    object cdsVarIntvar_codfator: TIntegerField
      FieldName = 'var_codfator'
      Required = True
    end
    object cdsVarIntvar_descricao: TWideStringField
      FieldName = 'var_descricao'
      Required = True
      Size = 250
    end
  end
  object dsVarInt: TDataSource
    DataSet = cdsVarInt
    Left = 184
    Top = 215
  end
  ...
  object frxDBDSAnaliseInterna: TfrxDBDataset
    UserName = 'frxDBDSAnaliseInterna'
    CloseDataSource = False
    FieldAliases.Strings = (
      'int_codigo=int_codigo'
      'int_codfator=int_codfator'
      'int_codvariavel=int_codvariavel'
      'int_tipo=int_tipo'
      'fator=fator'
      'var_descricao=var_descricao'
      'int_processo=int_processo'
      'processo=processo'
      'int_texto=int_texto')
    DataSet = cdsImprimir
    BCDToCurrency = False
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT int_codigo, int_codfator, int_codvariavel, int_tipo, int_' +
        'texto, int_processo,'
      'TC.valo_com as Fator, R.var_descricao, P.nome_pro as Processo'
      'FROM risco_analiseint'
      
        'INNER JOIN tabela_combos TC ON TC.codi_com = int_codfator and TC' +
        '.tipo_com = 23'
      
        'INNER JOIN risco_variaveis_int R ON R.var_codigo = int_codvariav' +
        'el'
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 440
    Top = 216
    object cdsImprimirint_codigo: TIntegerField
      FieldName = 'int_codigo'
      Required = True
    end
    object cdsImprimirint_codfator: TIntegerField
      FieldName = 'int_codfator'
      Required = True
    end
    object cdsImprimirint_codvariavel: TIntegerField
      FieldName = 'int_codvariavel'
      Required = True
    end
    object cdsImprimirint_tipo: TIntegerField
      FieldName = 'int_tipo'
      Required = True
    end
    ...
    object cdsImprimirint_processo: TIntegerField
      FieldName = 'int_processo'
      Required = True
    end
    ...
    object cdsImprimirint_texto: TWideMemoField
      FieldName = 'int_texto'
      Required = True
      BlobType = ftWideMemo
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42622.593721458300000000
    ...
    ScriptText.Strings = (
      ...
      'begin'
        ...
        '  if <frxDBDSAnaliseInterna."int_tipo"> = 0 then begin          ' +
        '    '
      
        '     Memo3.Memo.Text := <frxDBDSAnaliseInterna."int_texto">;    ' +
        '         '
      ...
      'begin'
        ...
        '  if <frxDBDSAnaliseInterna."int_tipo"> = 1 then begin          ' +
        '    '
      
        '     Memo5.Memo.Text := <frxDBDSAnaliseInterna."int_texto">;    ' +
        '         '
      '  end'
      '  else begin'
    ...
    Datasets = <
      item
        DataSet = frxDBDSAnaliseInterna
        DataSetName = 'frxDBDSAnaliseInterna'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Titulo: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'AN'#193'LISE INTERNA (AN'#193'LISE DE RISCO)')
          ParentFont = False
        end
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSAnaliseInterna."var_descricao"]')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object GrupoProcesso: TfrxGroupHeader
        ...
        Width = 1046.929810000000000000
        Condition = 'frxDBDSAnaliseInterna."processo"'
        object Memo6: TfrxMemoView
          Top = 25.677179999999990000
          Width = 260.787401570000000000
          Height = 18.897650000000000000
          ShowHint = False
        ...
        object Memo9: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            'Processo: [frxDBDSAnaliseInterna."processo"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object dspFatoresExt: TDataSetProvider
    DataSet = zqryFatoresExt
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 104
    Top = 175
  end
  object cdsFatoresExt: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspFatoresExt'
    Left = 144
    Top = 175
    object cdsFatoresExtcodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    object cdsFatoresExtvalo_com: TWideStringField
      FieldName = 'valo_com'
      Size = 50
    end
  end
  object dsFatoresExt: TDataSource
    DataSet = cdsFatoresExt
    Left = 184
    Top = 175
  end
  object zqryAnaliseInt: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      
        'SELECT int_codigo, int_codfator, int_codvariavel, int_tipo, int_' +
        'texto, int_processo, int_probabilidade, int_consequencia'
      'FROM risco_analiseint'
      'ORDER BY int_codigo')
    Params = <>
    Left = 64
  ...
  object dspAnaliseInt: TDataSetProvider
    DataSet = zqryAnaliseInt
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 104
    Top = 311
  end
  object cdsAnaliseInt: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspAnaliseInt'
    Left = 144
    Top = 311
    object cdsAnaliseIntint_codigo: TIntegerField
      FieldName = 'int_codigo'
      Required = True
    end
    object cdsAnaliseIntint_codfator: TIntegerField
      FieldName = 'int_codfator'
      Required = True
    end
    object cdsAnaliseIntint_codvariavel: TIntegerField
      FieldName = 'int_codvariavel'
      Required = True
    end
    object cdsAnaliseIntint_tipo: TIntegerField
      FieldName = 'int_tipo'
      Required = True
    end
    object cdsAnaliseIntint_processo: TIntegerField
      FieldName = 'int_processo'
      Required = True
    end
    object cdsAnaliseIntint_probabilidade: TIntegerField
      FieldName = 'int_probabilidade'
    end
    object cdsAnaliseIntint_consequencia: TIntegerField
      FieldName = 'int_consequencia'
    end
    object cdsAnaliseIntint_texto: TWideMemoField
      FieldName = 'int_texto'
      OnGetText = cdsAnaliseIntint_textoGetText
      BlobType = ftWideMemo
    end
  end
  object dsAnaliseInt: TDataSource
    DataSet = cdsAnaliseInt
    Left = 184
    Top = 311
  end
  object zqryFatoresImp: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_com, valo_com FROM tabela_combos')
    Params = <>
  ...
  object dspFatoresImp: TDataSetProvider
    DataSet = zqryFatoresImp
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 400
    Top = 263
  end
  object cdsFatoresImp: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspFatoresImp'
    Left = 440
    Top = 263
  ...
  object dsFatoresImp: TDataSource
    DataSet = cdsFatoresImp
    Left = 480
    Top = 263
  end
  ...
  object zqryProbabilidade: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_com, valo_com FROM tabela_combos')
    Params = <>
  ...
  object dspProbabilidade: TDataSetProvider
    DataSet = zqryProbabilidade
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 400
    Top = 328
  end
  object cdsProbabilidade: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspProbabilidade'
    Left = 440
    Top = 328
  end
  object dsProbabilidade: TDataSource
    DataSet = cdsProbabilidade
    Left = 480
    Top = 327
  end
  object zqryConsequencia: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_com, valo_com FROM tabela_combos')
    Params = <>
  ...
  object dspConsequencia: TDataSetProvider
    DataSet = zqryConsequencia
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 400
    Top = 376
  end
  object cdsConsequencia: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspConsequencia'
    Left = 440
    Top = 376
  end
  object dsConsequencia: TDataSource
    DataSet = cdsConsequencia
    Left = 480
    Top = 375
  end
  ...
  object zqryHistorico: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT his_codigo, his_codanalise, his_data, his_probabilidade, ' +
        'TC.valo_com as probabilidade, '
      
        'his_consequencia, TC1.valo_com as consequencia, his_texto, his_u' +
        'suario'
      'FROM risco_analiseint_hist'
      
        'INNER JOIN tabela_combos TC ON TC.tipo_com = 24 AND TC.codi_com ' +
        '= his_probabilidade'
      
        'INNER JOIN tabela_combos TC1 ON TC1.tipo_com = 25 AND TC1.codi_c' +
        'om = his_consequencia')
    Params = <>
    Left = 152
    Top = 423
  ...
  object cdsHistorico: TClientDataSet
    ...
    object cdsHistoricohis_codanalise: TIntegerField
      FieldName = 'his_codanalise'
    end
    object cdsHistoricohis_data: TDateTimeField
      FieldName = 'his_data'
    end
    object cdsHistoricohis_probabilidade: TIntegerField
      FieldName = 'his_probabilidade'
    end
    object cdsHistoricoprobabilidade: TWideStringField
      FieldName = 'probabilidade'
      Size = 50
    end
    object cdsHistoricohis_consequencia: TIntegerField
      FieldName = 'his_consequencia'
    end
    object cdsHistoricoconsequencia: TWideStringField
      FieldName = 'consequencia'
      Size = 50
    end
    object cdsHistoricohis_texto: TWideMemoField
      FieldName = 'his_texto'
      OnGetText = cdsHistoricohis_textoGetText
      BlobType = ftWideMemo
    end
  ...
  object zqryProcessoFiltro: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_pro, nome_pro'
      'FROM processos'
  ...
  object dspProcessoFiltro: TDataSetProvider
    DataSet = zqryProcessoFiltro
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 232
    Top = 15
  end
  object cdsProcessoFiltro: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspProcessos'
    Left = 272
  ...
  object dsProcessoFiltro: TDataSource
    DataSet = cdsProcessoFiltro
    Left = 312
    Top = 15
  end
end
