object FormCadTipoInspecao: TFormCadTipoInspecao
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Tipos de Inspe'#231#227'o'
  ClientHeight = 373
  ClientWidth = 542
  Color = clBtnFace
  ...
  object frxDBDSListaTipoInspecao: TfrxDBDataset
    UserName = 'frxDBDSListaTipoInspecao'
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 440
    Top = 216
    object cdsImprimirtip_codigo: TIntegerField
      FieldName = 'tip_codigo'
      Required = True
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43390.444124583330000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSListaTipoInspecao
        DataSetName = 'frxDBDSListaTipoInspecao'
      end>
    Variables = <
      item
    ...
    object Page1: TfrxReportPage
      ...
      object Titulo: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'LISTAGEM DE TIPOS DE INSPE'#199#195'O')
          ParentFont = False
        end
        ...
        object Memo9: TfrxMemoView
          Left = 100.929190000000000000
          Top = 103.102362200000000000
          Width = 563.149970000001200000
          Height = 18.897650000000000000
          ShowHint = False
          Color = cl3DLight
          DisplayFormat.DecimalSeparator = ','
      ...
      object Detalhe: TfrxMasterData
        ...
        object mCodigo: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSListaTipoInspecao."tip_codigo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object mDescricao: TfrxMemoView
          Left = 100.771653540000000000
          Width = 563.527766540001200000
          Height = 18.897650000000000000
          ShowHint = False
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBDSListaTipoInspecao."tip_descricao"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
