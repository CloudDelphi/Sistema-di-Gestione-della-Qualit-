object FormAuditoriaAgenda2015: TFormAuditoriaAgenda2015
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Agenda da Auditoria Interna - ISO 9001:2015'
  ClientHeight = 499
  ClientWidth = 938
  Color = clBtnFace
  ...
  object dbgForn: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'HoraPrevista'
        Title.Caption = 'Hor'#225'rio Previsto'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
        Title.Font.Name = 'Tahoma'
      ...
      item
        Expanded = False
        FieldName = 'aud_auditores'
        Title.Caption = 'Auditores'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
        Title.Font.Name = 'Tahoma'
  ...
  object dblAuditado: TDBLookupComboBox
    Left = 526
    Top = 79
    Width = 404
    Height = 26
  ...
  object zqryAgenda: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT aud_codigo, aud_cod_auditoria, aud_data, aud_horaini, aud' +
        '_horafim, '
      '       aud_auditores, aud_auditado, aud_processo'
  ...
  object cdsAgenda: TClientDataSet
    ...
    OnCalcFields = cdsAgendaCalcFields
    Left = 144
    Top = 208
    object cdsAgendaaud_codigo: TIntegerField
      FieldName = 'aud_codigo'
      Required = True
    end
    object cdsAgendaaud_cod_auditoria: TIntegerField
      FieldName = 'aud_cod_auditoria'
      Required = True
    end
    object cdsAgendaaud_data: TDateField
      FieldName = 'aud_data'
      Required = True
    end
    object cdsAgendaaud_horaini: TWideStringField
      FieldName = 'aud_horaini'
      Size = 5
    end
    object cdsAgendaaud_horafim: TWideStringField
      FieldName = 'aud_horafim'
      Size = 5
    end
    object cdsAgendaaud_auditores: TWideStringField
      FieldName = 'aud_auditores'
      Size = 80
    end
    object cdsAgendaHoraPrevista: TStringField
      FieldKind = fkCalculated
      FieldName = 'HoraPrevista'
      Size = 15
      Calculated = True
    end
    object cdsAgendaaud_processo: TIntegerField
      FieldName = 'aud_processo'
    end
    object cdsAgendaNomeProcesso: TStringField
      FieldKind = fkLookup
      FieldName = 'NomeProcesso'
    ...
    object cdsAgendaaud_auditado: TIntegerField
      FieldName = 'aud_auditado'
      ReadOnly = True
    end
    object cdsAgendaNomeAuditado: TStringField
      FieldKind = fkLookup
      FieldName = 'NomeAuditado'
      LookupDataSet = cdsColaboradores
      LookupKeyFields = 'codi_col'
      LookupResultField = 'nome_col'
      KeyFields = 'aud_auditado'
      Size = 100
      Lookup = True
    end
  end
