object FormCadIndicadores: TFormCadIndicadores
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctIndicadores: TJvgPageControl
    Left = 0
    Top = 0
    Width = 823
    Height = 457
    ...
    object tsCadastro: TTabSheet
      ...
      object lblPeriodo: TLabel
        ...
        Width = 126
        Height = 13
        Caption = 'Periodicidade do Indicador'
      end
      object lbl11: TLabel
        Left = 270
        Top = 231
      ...
      object lbl3: TLabel
        ...
        Width = 132
        Height = 13
        Caption = 'Respons'#225'vel pelo Indicador'
      end
      ...
      object lbl17: TLabel
        ...
        Width = 75
        Height = 13
        Caption = 'PDCA vinculado'
      end
      object sbVincularPDCA: TSpeedButton
        Left = 570
        Top = 167
        Width = 32
        Height = 31
        Hint = 'Clique para vincular um PDCA existente'
        Glyph.Data = {
          B60D0000424DB60D000000000000360000002800000030000000180000000100
          180000000000800D0000120B0000120B00000000000000000000FFFFFFFFFFFF
          FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
        ...
        ParentShowHint = False
        ShowHint = True
        OnClick = sbVincularPDCAClick
      end
      object sbDesvincularPDCA: TSpeedButton
        Left = 606
        Top = 167
        Width = 32
        Height = 31
        Hint = 'Clique para desvincular o PDCA'
        Glyph.Data = {
          B60D0000424DB60D000000000000360000002800000030000000180000000100
          180000000000800D0000120B0000120B00000000000000000000FFFFFFFFFFFF
          FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
        ...
        ParentShowHint = False
        ShowHint = True
        OnClick = sbDesvincularPDCAClick
      end
      object lbl18: TLabel
        Left = 728
        Top = 199
      ...
      object dblMeta: TDBLookupComboBox
        Left = 270
        Top = 247
        Width = 156
        Height = 26
      ...
      object pnlImprimir: TPanel
        ...
        object pnl3: TPanel
          ...
          Caption = ' Impress'#227'o de Indicadores'
    ...
    object tsMetas: TTabSheet
      ...
      object dblTipoMeta: TDBLookupComboBox
        Left = 266
        Top = 76
        Width = 165
        Height = 26
      ...
      object dbgMetas: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'DescTipoMeta'
            Title.Caption = 'Tipo Meta'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
      ...
      object pnlImpMetas: TPanel
        ...
        object pnl5: TPanel
          ...
          object btnSairImpMetas: TBitBtn
            ...
            ShowHint = True
            TabOrder = 2
            OnClick = btnSairImpMetasClick
          end
          object btnVideoMetas: TBitBtn
            Left = 1
            Top = 1
            Width = 73
            Height = 70
            ...
            ShowHint = True
            TabOrder = 0
            OnClick = btnVideoMetasClick
          end
          object btnVideoImp: TBitBtn
            Left = 74
            Top = 1
            Width = 73
            Height = 70
        ...
        object pnl6: TPanel
          ...
          Align = alTop
          Alignment = taLeftJustify
          Caption = ' Impress'#227'o de Metas dos Indicadores'
          Color = clGradientActiveCaption
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -15
        ...
        object rgOrdemMetas: TRadioGroup
          Tag = 30
          Left = 15
          Top = 45
          Width = 378
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT I.codi_ind, I.desc_ind, I.meta_ind, I.proc_ind, I.tipo_in' +
        'd, I.peri_ind, '
      
        'I.ind_unidade, I.ind_objetivo, I.ind_caminho_base, I.ind_metodol' +
        'ogia, P.nome_pro,'
      
        '(SELECT met_valor || '#39' '#39' || met_unidade FROM indicadores_metas W' +
        'HERE met_codindicador = I.codi_ind ORDER BY met_anomes desc limi' +
        't 1 ) as meta_atual,'
      
        '(SELECT met_anomes FROM indicadores_metas WHERE met_codindicador' +
        ' = I.codi_ind ORDER BY met_anomes desc limit 1 ) as mes_atual,'
      '(SELECT TC.valo_com FROM indicadores_metas '
      
        'INNER JOIN tabela_combos TC ON TC.tipo_com = 17 AND TC.codi_com ' +
        '= met_tipo'
      
        'WHERE met_codindicador = I.codi_ind ORDER BY met_anomes desc lim' +
        'it 1 ) as tipo_atual'
      'FROM indicadores I'
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 512
    Top = 184
    object cdsImprimircodi_ind: TLargeintField
      FieldName = 'codi_ind'
      Required = True
    end
    object cdsImprimirdesc_ind: TWideStringField
      FieldName = 'desc_ind'
      Size = 80
    end
    object cdsImprimirmeta_ind: TFloatField
      FieldName = 'meta_ind'
      EditFormat = '00.00'
    end
    object cdsImprimirproc_ind: TLargeintField
      FieldName = 'proc_ind'
    end
    object cdsImprimirperi_ind: TLargeintField
      FieldName = 'peri_ind'
    end
    ...
    object cdsImprimirDescTipoMeta: TStringField
      FieldKind = fkLookup
      FieldName = 'DescTipoMeta'
      LookupDataSet = cdsMeta
      LookupKeyFields = 'codi_com'
      LookupResultField = 'valo_com'
      KeyFields = 'tipo_ind'
      Lookup = True
    end
    object cdsImprimirind_unidade: TWideStringField
      FieldName = 'ind_unidade'
    end
    object cdsImprimirind_objetivo: TWideStringField
      FieldName = 'ind_objetivo'
      Size = 120
    end
    object cdsImprimirind_caminho_base: TMemoField
      FieldName = 'ind_caminho_base'
      BlobType = ftMemo
    end
    object cdsImprimirind_metodologia: TMemoField
      FieldName = 'ind_metodologia'
      BlobType = ftMemo
    end
    object cdsImprimirtipo_ind: TIntegerField
      FieldName = 'tipo_ind'
    end
    ...
    object cdsImprimirmeta_atual: TWideMemoField
      FieldName = 'meta_atual'
      ReadOnly = True
      BlobType = ftWideMemo
    end
    object cdsImprimirmes_atual: TWideStringField
      FieldName = 'mes_atual'
      ReadOnly = True
      Size = 6
    end
    object cdsImprimirtipo_atual: TWideStringField
      FieldName = 'tipo_atual'
      ReadOnly = True
      Size = 50
    end
    object cdsImprimirMesAno: TStringField
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42293.566330902800000000
    ...
    Datasets = <
      item
        DataSet = frxDBIndicadores
        DataSetName = 'frxDBIndicadores'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Detalhe: TfrxMasterData
        ...
        object frxControleDATA: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBIndicadores."codi_ind"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo2: TfrxMemoView
          Left = 44.834645670000000000
          Width = 313.322822440000000000
          Height = 37.795300000000000000
          ShowHint = False
          DataField = 'desc_ind'
          DataSet = frxDBIndicadores
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBIndicadores."desc_ind"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo8: TfrxMemoView
          Left = 357.779527560000000000
          Width = 105.826644720000000000
          Height = 37.795300000000000000
          ShowHint = False
          DataField = 'DescTipoMeta'
          DataSet = frxDBIndicadores
          DataSetName = 'frxDBIndicadores'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBIndicadores."DescTipoMeta"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo12: TfrxMemoView
          Left = 463.606299210000000000
          Width = 56.692754720000000000
          Height = 37.795300000000000000
          ShowHint = False
          DataField = 'meta_ind'
          DataSet = frxDBIndicadores
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBIndicadores."meta_ind"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo14: TfrxMemoView
          Left = 634.205320000000000000
          Width = 84.283464566929100000
          Height = 37.795300000000000000
          ShowHint = False
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBIndicadores."DescPeriodo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo3: TfrxMemoView
          Left = 520.677165350000000000
          Width = 113.385704720000000000
          Height = 37.795300000000000000
          ShowHint = False
          DataField = 'ind_unidade'
          DataSet = frxDBIndicadores
          DataSetName = 'frxDBIndicadores'
          DisplayFormat.FormatStr = '%2.2f'
          DisplayFormat.Kind = fkNumeric
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBIndicadores."ind_unidade"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo5: TfrxMemoView
          Top = 56.795300000000030000
          Width = 717.732532440000000000
          Height = 37.795275590551200000
          ShowHint = False
          DataField = 'ind_objetivo'
          DataSet = frxDBIndicadores
          DataSetName = 'frxDBIndicadores'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBIndicadores."ind_objetivo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo9: TfrxMemoView
          Top = 37.897650000000030000
          Width = 718.110648740000000000
      ...
      object Rodape: TfrxPageFooter
        ...
        object Line1: TfrxLineView
          ...
          Width = 657.637829450000000000
          ShowHint = False
          Frame.Typ = [ftTop]
        end
      end
      object GroupHeader1: TfrxGroupHeader
        Height = 44.929190000000000000
        Top = 173.858380000000000000
        Width = 718.110700000000000000
        Condition = '<frxDBIndicadores."nome_pro">'
        KeepTogether = True
        ...
        object Memo1: TfrxMemoView
          Left = 44.866420000000000000
          Top = 26.031540000000010000
          Width = 313.322844410000000000
          Height = 18.897650000000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
  ...
  object frxDBIndicadores: TfrxDBDataset
    UserName = 'frxDBIndicadores'
    ...
    FieldAliases.Strings = (
      ...
      'DescTipoMeta=DescTipoMeta'
      'ind_unidade=ind_unidade'
      'ind_objetivo=ind_objetivo'
      'ind_caminho_base=ind_caminho_base'
      'ind_metodologia=ind_metodologia'
      'tipo_ind=tipo_ind'
      'nome_pro=nome_pro'
  ...
  object dspMeta: TDataSetProvider
    DataSet = zqryMeta
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 632
  ...
  object cdsMeta: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspMeta'
    Left = 672
    Top = 320
    object cdsMetacodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    object cdsMetavalo_com: TWideStringField
      FieldName = 'valo_com'
      Size = 50
    end
  end
  ...
  object cdsResp: TClientDataSet
    ...
    Left = 184
    Top = 328
    object cdsRespcodi_fun: TLargeintField
      FieldName = 'codi_fun'
      Required = True
    end
    object cdsRespdesc_fun: TWideStringField
      FieldName = 'desc_fun'
      Size = 50
    end
  end
  ...
  object zqryMetas: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      
        'SELECT met_codigo, met_codindicador, met_anomes, met_tipo, met_v' +
        'alor,  met_unidade'
  ...
  object cdsMetas: TClientDataSet
    ...
    Left = 672
    Top = 376
    object cdsMetasmet_codigo: TIntegerField
      FieldName = 'met_codigo'
      Required = True
    end
    object IntegerField2: TIntegerField
      FieldName = 'met_codindicador'
      Required = True
    end
    ...
    object cdsMetasano: TStringField
      FieldKind = fkCalculated
      FieldName = 'ano'
      Size = 4
      Calculated = True
    end
    object cdsMetasmes: TStringField
      FieldKind = fkCalculated
      FieldName = 'mes'
      Size = 10
      Calculated = True
    end
    object cdsMetasDescTipoMeta: TStringField
      FieldKind = fkLookup
      FieldName = 'DescTipoMeta'
      LookupDataSet = cdsMeta
      LookupKeyFields = 'codi_com'
  ...
  object frxDBMetas: TfrxDBDataset
    UserName = 'frxDBMetas'
    CloseDataSource = False
    FieldAliases.Strings = (
      'met_codigo=met_codigo'
      'met_codindicador=met_codindicador'
      'met_anomes=met_anomes'
      'met_tipo=met_tipo'
      'met_valor=met_valor'
      'met_unidade=met_unidade'
  ...
  object dspImpMetas: TDataSetProvider
    DataSet = zqryImpMetas
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 472
    Top = 232
  end
  object cdsImpMetas: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspImpMetas'
    OnCalcFields = cdsImpMetasCalcFields
    Left = 512
    Top = 232
    object cdsImpMetasmet_codigo: TIntegerField
      FieldName = 'met_codigo'
      Required = True
    end
    object cdsImpMetasmet_codindicador: TIntegerField
      FieldName = 'met_codindicador'
      Required = True
    end
    object cdsImpMetasmet_anomes: TWideStringField
      FieldName = 'met_anomes'
      Required = True
      Size = 6
    end
    object cdsImpMetasmet_tipo: TIntegerField
      FieldName = 'met_tipo'
      Required = True
    end
    object cdsImpMetasmet_valor: TFloatField
      FieldName = 'met_valor'
    end
    object cdsImpMetasmet_unidade: TWideStringField
      FieldName = 'met_unidade'
      Size = 50
    end
    object cdsImpMetasDescIndicador: TStringField
      FieldKind = fkLookup
      FieldName = 'DescIndicador'
      LookupDataSet = cdsIndicadores
      LookupKeyFields = 'codi_ind'
      LookupResultField = 'desc_ind'
      KeyFields = 'met_codindicador'
      Size = 80
      Lookup = True
    end
    object cdsImpMetasMesAno: TStringField
      FieldKind = fkCalculated
      FieldName = 'MesAno'
      Calculated = True
    end
  ...
  object zqryMonitoramento: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_com, valo_com FROM tabela_combos')
    Params = <>
