object FormLira: TFormLira
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Lista Interna de Requisitos Aplic'#225'veis ao Meio Ambiente'
  ClientHeight = 508
  ClientWidth = 808
  Color = clBtnFace
  ...
  object pctLira: TJvgPageControl
    ...
    object tsCadastro: TTabSheet
      ...
      object lbl12: TLabel
        ...
        Width = 117
        Height = 13
        Caption = 'Frequ'#234'ncia da Avalia'#231#227'o'
      end
      object lbl13: TLabel
        Left = 519
        Top = 233
        Width = 110
        Height = 13
        Caption = 'Data '#218'ltima Verifica'#231#227'o'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object lbl5: TLabel
        ...
        Width = 94
        Height = 13
        Caption = #211'rg'#227'o Respons'#225'vel'
      end
      object lbl1: TLabel
        Left = 7
        Top = 12
      ...
      object lbl6: TLabel
        ...
        Width = 117
        Height = 13
        Caption = 'Frequ'#234'ncia de Avalia'#231#227'o'
      end
      object lbl14: TLabel
        Left = 634
        Top = 103
      ...
      object lbl7: TLabel
        ...
        Width = 139
        Height = 13
        Caption = 'Respons'#225'vel pela Verifica'#231#227'o'
      end
      ...
      object dblFreqEvid: TDBLookupComboBox
        Left = 391
        Top = 249
        Width = 124
        Height = 26
        ...
        KeyField = 'codi_com'
        ListField = 'valo_com'
        ListSource = dsFreqEvid
        ParentFont = False
        TabOrder = 11
      end
      object dblAlteracaoEvid: TDBLookupComboBox
        Left = 634
        Top = 249
        Width = 88
        Height = 26
        ...
        KeyField = 'codi_com'
        ListField = 'valo_com'
        ListSource = dsAlteracaoEvid
        ParentFont = False
        TabOrder = 13
      end
      object dtVerificacaoEvid: TDateEdit
        Left = 519
        Top = 249
        Width = 109
        Height = 26
      ...
      object dblAmbito: TDBLookupComboBox
        Left = 7
        Top = 71
        Width = 149
        Height = 26
      ...
      object dtVerificacao: TDateEdit
        Left = 519
        Top = 119
        Width = 109
        Height = 26
      ...
      object mmoSumario: TMemo
        ...
        TabOrder = 6
        OnExit = mmoSumarioExit
        OnKeyPress = mmoSumarioKeyPress
      end
      object mmoEvidencia: TMemo
        Left = 7
        Top = 249
        Width = 378
        Height = 113
        ...
        ScrollBars = ssVertical
        TabOrder = 10
        OnExit = mmoEvidenciaExit
        OnKeyPress = mmoEvidenciaKeyPress
      end
      ...
      object dblAlteracao: TDBLookupComboBox
        Left = 634
        Top = 119
        Width = 88
        Height = 26
  ...
  object dspAmbito: TDataSetProvider
    DataSet = zqryAmbito
  ...
  object cdsAmbito: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspAmbito'
    Left = 112
    Top = 224
    object cdsAmbitocodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    object cdsAmbitovalo_com: TWideStringField
      FieldName = 'valo_com'
      Size = 50
    end
  end
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT lir_identificacao, lir_descricao, lir_ambito, lir_tema, l' +
        'ir_orgao,'
      
        'lir_sumario, lir_evidencia, lir_documento, lir_avaliacao, lir_da' +
        'taVerificacao, '
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 592
    Top = 72
    object cdsImprimirDescFreq: TStringField
      FieldKind = fkLookup
      FieldName = 'DescFreq'
      LookupDataSet = cdsFreq
      LookupKeyFields = 'codi_com'
      LookupResultField = 'valo_com'
      KeyFields = 'lir_avaliacao'
      Lookup = True
    end
    object cdsImprimirDescAlteracao: TStringField
      FieldKind = fkLookup
      FieldName = 'DescAlteracao'
      LookupDataSet = cdsAlteracao
      LookupKeyFields = 'codi_com'
      LookupResultField = 'valo_com'
      KeyFields = 'lir_alterada'
      Size = 3
      Lookup = True
    end
    object cdsImprimirDescAmbito: TStringField
      FieldKind = fkLookup
      FieldName = 'DescAmbito'
      LookupDataSet = cdsAmbito
      LookupKeyFields = 'codi_com'
      LookupResultField = 'valo_com'
      KeyFields = 'lir_ambito'
      Lookup = True
    end
    object cdsImprimirlir_identificacao: TWideStringField
      FieldName = 'lir_identificacao'
      Size = 6
    end
    object cdsImprimirlir_descricao: TWideStringField
      FieldName = 'lir_descricao'
      Size = 80
    end
    object cdsImprimirlir_ambito: TWideStringField
      FieldName = 'lir_ambito'
    end
    object cdsImprimirlir_tema: TWideStringField
      FieldName = 'lir_tema'
      Size = 80
    end
    object cdsImprimirlir_orgao: TWideStringField
      FieldName = 'lir_orgao'
    end
    object cdsImprimirlir_sumario: TWideMemoField
      FieldName = 'lir_sumario'
      BlobType = ftWideMemo
    end
    object cdsImprimirlir_evidencia: TWideMemoField
      FieldName = 'lir_evidencia'
      BlobType = ftWideMemo
    end
    object cdsImprimirlir_documento: TWideMemoField
      FieldName = 'lir_documento'
      BlobType = ftWideMemo
    end
    object cdsImprimirlir_avaliacao: TLargeintField
      FieldName = 'lir_avaliacao'
    end
    object cdsImprimirlir_dataverificacao: TDateField
      FieldName = 'lir_dataverificacao'
    end
    object cdsImprimirlir_alterada: TLargeintField
      FieldName = 'lir_alterada'
    end
    object cdsImprimirlir_responsavel: TWideStringField
      FieldName = 'lir_responsavel'
      Size = 80
    end
  end
  object zqryLira: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT lir_codigo, lir_identificacao, lir_descricao, lir_ambito,' +
        ' lir_tema, lir_orgao, lir_sumario, lir_evidencia, lir_documento,' +
        ' '
      
        'lir_avaliacao, lir_dataVerificacao, lir_alterada, lir_responsave' +
        'l, lir_avaliacaoEvid, lir_dataVerificacaoEvid, lir_alteradaEvid'
      'FROM lira')
    Params = <>
    Left = 400
    Top = 200
  ...
  object cdsLira: TClientDataSet
    ...
    object cdsLiralir_ambito: TWideStringField
      FieldName = 'lir_ambito'
    end
    object cdsLiralir_tema: TWideStringField
      FieldName = 'lir_tema'
      Size = 80
    end
    object cdsLiralir_orgao: TWideStringField
      FieldName = 'lir_orgao'
    end
    object cdsLiralir_sumario: TWideMemoField
      FieldName = 'lir_sumario'
      BlobType = ftWideMemo
    end
    object cdsLiralir_evidencia: TWideMemoField
      FieldName = 'lir_evidencia'
      BlobType = ftWideMemo
    end
    object cdsLiralir_documento: TWideMemoField
      FieldName = 'lir_documento'
      BlobType = ftWideMemo
    end
    object cdsLiralir_avaliacao: TLargeintField
      FieldName = 'lir_avaliacao'
    end
    object cdsLiralir_dataverificacao: TDateField
      FieldName = 'lir_dataverificacao'
    end
    object cdsLiralir_alterada: TLargeintField
      FieldName = 'lir_alterada'
    end
    object cdsLiralir_responsavel: TWideStringField
      FieldName = 'lir_responsavel'
      Size = 80
    end
    object cdsLiralir_avaliacaoevid: TLargeintField
      FieldName = 'lir_avaliacaoevid'
    end
    object cdsLiralir_dataverificacaoevid: TDateField
      FieldName = 'lir_dataverificacaoevid'
    end
    object cdsLiralir_alteradaevid: TLargeintField
      FieldName = 'lir_alteradaevid'
    end
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 41569.720224641200000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'L.I.R.A. - LISTA INTERNA DE REQUISITOS APLIC'#193'VEIS AO MEIO AMBIEN' +
              'TE')
          ParentFont = False
        end
        ...
        object Memo9: TfrxMemoView
          Left = 422.062992130000000000
          Top = 58.102362200000000000
        ...
        object Memo12: TfrxMemoView
          Left = 230.244094490000000000
          Top = 58.370130000000000000
          Width = 45.354213540000000000
          Height = 37.795300000000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo14: TfrxMemoView
          Left = 275.110236220000000000
          Top = 58.590600000000000000
          Width = 147.401523540000000000
          Height = 37.795300000000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo3: TfrxMemoView
          Left = 782.260360000000000000
          Top = 58.472480000000000000
          Width = 90.708632130000000000
          Height = 37.795300000000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo17: TfrxMemoView
          Left = 873.087200000000000000
          Top = 58.582677170000000000
          Width = 64.251922130000000000
          Height = 37.795300000000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Data '#218'ltima Verifica'#231#227'o')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo19: TfrxMemoView
          Left = 936.780150000000000000
          Top = 58.582677170000000000
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Resp. pela Verifica'#231#227'o')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo20: TfrxMemoView
          Left = 1004.732283460000000000
          Top = 58.582677170000000000
          Width = 42.708661417322800000
          Height = 37.795300000000000000
          ShowHint = False
          DisplayFormat.DecimalSeparator = ','
          Font.Charset = DEFAULT_CHARSET
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo1: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBDSLira."lir_descricao"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo15: TfrxMemoView
          Left = 275.071120000000000000
          Width = 147.401523540000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lir_tema'
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBDSLira."lir_tema"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo13: TfrxMemoView
          Left = 230.244280000000000000
          Width = 45.354294090000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'DescAmbito'
          DataSet = frxDBDSLira
          DataSetName = 'frxDBDSLira'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLira."DescAmbito"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo2: TfrxMemoView
          Left = 422.063390000000000000
          Width = 71.810972360000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lir_orgao'
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLira."lir_orgao"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo5: TfrxMemoView
          Left = 494.228820000000000000
          Width = 143.622042360000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lir_sumario'
          DataSet = frxDBDSLira
          DataSetName = 'frxDBDSLira'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object Memo10: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLira."lir_evidencia"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo16: TfrxMemoView
          Left = 782.039890000000000000
          Width = 90.708644330000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'lir_documento'
          DataSet = frxDBDSLira
          DataSetName = 'frxDBDSLira'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
        ...
        object Memo18: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLira."lir_dataVerificacao"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo21: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSLira."lir_responsavel"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo22: TfrxMemoView
          Left = 1005.575450000000000000
          Width = 41.574800710000000000
          Height = 60.472480000000000000
          ShowHint = False
          DataField = 'DescAlteracao'
          DataSet = frxDBDSLira
          DataSetName = 'frxDBDSLira'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
  ...
  object frxDBDSLira: TfrxDBDataset
    UserName = 'frxDBDSLira'
    CloseDataSource = False
    FieldAliases.Strings = (
      'lir_identificacao=lir_identificacao'
      'lir_descricao=lir_descricao'
      'lir_ambito=lir_ambito'
      'lir_tema=lir_tema'
      'lir_orgao=lir_orgao'
      'lir_sumario=lir_sumario'
      'lir_evidencia=lir_evidencia'
      'lir_documento=lir_documento'
      'lir_avaliacao=lir_avaliacao'
      'lir_dataVerificacao=lir_dataVerificacao'
      'lir_alterada=lir_alterada'
      'lir_responsavel=lir_responsavel'
      'DescAmbito=DescAmbito'
      'DescAlteracao=DescAlteracao'
      'DescFreq=DescFreq')
    DataSet = cdsImprimir
    BCDToCurrency = False
    Left = 440
  ...
  object dspFreqEvid: TDataSetProvider
    DataSet = zqryFreqEvid
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 680
    Top = 352
  end
  object cdsFreqEvid: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspFreqEvid'
    Left = 720
    Top = 352
  ...
  object dsFreqEvid: TDataSource
    DataSet = cdsFreqEvid
    Left = 760
    Top = 352
  end
  object zqryAlteracaoEvid: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT codi_com, valo_com FROM tabela_combos')
    Params = <>
  ...
  object dspAlteracaoEvid: TDataSetProvider
    DataSet = zqryAlteracaoEvid
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 680
    Top = 392
  end
  object cdsAlteracaoEvid: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspAlteracaoEvid'
    Left = 720
    Top = 392
  ...
  object dsAlteracaoEvid: TDataSource
    DataSet = cdsAlteracaoEvid
    Left = 760
    Top = 392
  end
