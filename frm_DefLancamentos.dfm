object FormDefLancamentos: TFormDefLancamentos
  Left = 0
  Top = 0
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctDefeito: TJvgPageControl
    Left = 0
    Top = 0
    Width = 577
    Height = 365
    ...
    object tsCadastro: TTabSheet
      ...
      object edtRastreabilidade: TEdit
        Left = 346
        Top = 77
        Width = 206
        Height = 26
    ...
    object tsLancamentos: TTabSheet
      ...
      object edtCodLanc: TEdit
        ...
        ParentFont = False
        TabOrder = 2
        OnExit = edtCodLancExit
      end
      object dblDefeito: TDBLookupComboBox
        Left = 68
        Top = 80
        Width = 368
        Height = 26
        ...
        Font.Style = []
        KeyField = 'def_codigo'
        ListField = 'def_descricao'
        ListSource = dsDefeitos
        ParentFont = False
        TabOrder = 3
        OnCloseUp = dblDefeitoCloseUp
      end
      object spnQtdLanc: TRxSpinEdit
        Left = 442
        Top = 80
        Width = 104
        Height = 26
    ...
    object tsPesquisa: TTabSheet
      ...
      object dbgLancamentosDef: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'lan_rastreabilidade'
            Title.Caption = 'Rastreabilidade'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object zqryLanc: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT lan_codigo, lan_data, lan_origem, lan_produto, lan_rastre' +
        'abilidade, '
      
        'lan_qtd, lan_status, O.ori_descricao, P.pro_descricao, TC.valo_c' +
        'om as status'
      'FROM defeitos_lanc L'
      'INNER JOIN defeitos_origem O ON O.ori_codigo = L.lan_origem'
      'INNER JOIN produtos P ON P.pro_codigo = L.lan_produto'
      
        'INNER JOIN tabela_combos TC ON TC.tipo_com = 26 AND TC.codi_com ' +
        '= L.lan_status')
    Params = <>
    Left = 64
    Top = 215
  ...
  object cdsLanc: TClientDataSet
    ...
    object cdsLanclan_data: TDateTimeField
      FieldName = 'lan_data'
    end
    object cdsLanclan_origem: TIntegerField
      FieldName = 'lan_origem'
      Required = True
    end
    object cdsLanclan_produto: TIntegerField
      FieldName = 'lan_produto'
      Required = True
    end
    object cdsLanclan_rastreabilidade: TWideStringField
      FieldName = 'lan_rastreabilidade'
      Size = 200
    end
    object cdsLanclan_qtd: TFloatField
      FieldName = 'lan_qtd'
      Required = True
    end
    ...
    object cdsLancori_descricao: TWideStringField
      FieldName = 'ori_descricao'
      Size = 200
    end
    object cdsLancpro_descricao: TWideStringField
      FieldName = 'pro_descricao'
      Size = 200
    end
    object cdsLancstatus: TWideStringField
      FieldName = 'status'
      Size = 50
    end
  end
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT D.def_codigo, D.def_descricao, D.def_classe, C.cla_descri' +
        'cao'
      'FROM defeitos D'
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 320
    Top = 328
    object cdsImprimirdef_codigo: TIntegerField
      FieldName = 'def_codigo'
      Required = True
    end
    object cdsImprimirdef_descricao: TWideStringField
      FieldName = 'def_descricao'
      Size = 200
    end
    object cdsImprimirdef_classe: TIntegerField
      FieldName = 'def_classe'
      Required = True
    end
    object cdsImprimircla_descricao: TWideStringField
      FieldName = 'cla_descricao'
      Size = 200
    end
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42353.694213229200000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSDefeito
        DataSetName = 'frxDBDSDefeito'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Detalhe: TfrxMasterData
        ...
        object mCodigo: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSDefeito."def_codigo"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object mDescricao: TfrxMemoView
          Left = 59.771653540000000000
          Width = 242.267716535433000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'cla_descricao'
          DataSet = frxDBDSDefeito
          DataSetName = 'frxDBDSDefeito'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBDSDefeito."cla_descricao"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo2: TfrxMemoView
          Left = 301.937230000000000000
          Width = 404.409475670000000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'def_descricao'
          DataSet = frxDBDSDefeito
          DataSetName = 'frxDBDSDefeito'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
  ...
  object frxDBDSDefeito: TfrxDBDataset
    UserName = 'frxDBDSDefeito'
    CloseDataSource = False
    FieldAliases.Strings = (
      'def_codigo=def_codigo'
      'def_descricao=def_descricao'
  ...
  object cdsProduto: TClientDataSet
    ...
    object cdsProdutopro_descricao: TWideStringField
      FieldName = 'pro_descricao'
      Size = 200
    end
  end
  ...
  object cdsStatus: TClientDataSet
    ...
    Left = 488
    Top = 247
    object cdsStatuscodi_com: TLargeintField
      FieldName = 'codi_com'
      Required = True
    end
    object cdsStatusvalo_com: TWideStringField
      FieldName = 'valo_com'
      Size = 50
    end
  end
  ...
  object zqryLancItem: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      
        'SELECT I.ite_codigo, I.lan_codigo, I.lan_defeito, I.lan_qtd, D.d' +
        'ef_descricao'
  ...
  object dspLancItem: TDataSetProvider
    DataSet = zqryLancItem
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 448
    Top = 311
  end
  object cdsLancItem: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspLancItem'
    Left = 488
    Top = 311
    object cdsLancItemite_codigo: TIntegerField
      FieldName = 'ite_codigo'
      Required = True
    end
    object cdsLancItemlan_codigo: TIntegerField
      FieldName = 'lan_codigo'
      Required = True
    end
    object cdsLancItemlan_defeito: TIntegerField
      FieldName = 'lan_defeito'
      Required = True
    end
    object cdsLancItemlan_qtd: TFloatField
      FieldName = 'lan_qtd'
      Required = True
    end
    object cdsLancItemdef_descricao: TWideStringField
      FieldName = 'def_descricao'
      Size = 200
    end
  end
  object dsLancItem: TDataSource
    DataSet = cdsLancItem
    Left = 528
    Top = 311
  end
  object zqryDefeitos: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT def_codigo, def_descricao, def_classe'
      '  FROM defeitos')
    Params = <>
    Left = 64
    Top = 319
  ...
  object cdsDefeitos: TClientDataSet
    ...
    Left = 144
    Top = 319
    object cdsDefeitosdef_codigo: TIntegerField
      FieldName = 'def_codigo'
      Required = True
    end
    object cdsDefeitosdef_descricao: TWideStringField
      FieldName = 'def_descricao'
      Size = 200
    end
    object cdsDefeitosdef_classe: TIntegerField
      FieldName = 'def_classe'
      Required = True
    end
  end
