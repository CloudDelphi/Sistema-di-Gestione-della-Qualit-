object FormCadTabelaPadraoInsp: TFormCadTabelaPadraoInsp
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Tabela Padr'#227'o de Inspe'#231#227'o'
  ClientHeight = 432
  ClientWidth = 723
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctHabilidades: TJvgPageControl
    Left = 0
    Top = 0
    Width = 723
    Height = 360
    ...
    object tsCadastro: TTabSheet
      ...
      object dbgCotas: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'tab_tolerancia_menos'
      ...
      object btnInserirCota: TBitBtn
        Left = 521
        Top = 60
        Width = 82
        Height = 51
        Hint = 'Insere a Cota na lista'
        Caption = 'Inserir'
        DoubleBuffered = True
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        ...
        ShowHint = True
        TabOrder = 7
        OnClick = btnInserirCotaClick
      end
      object btnExcluirCota: TBitBtn
        Left = 609
        Top = 60
        Width = 82
        Height = 51
      ...
      object dbgTabela: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Descri'#231#227'o da Tabela Padr'#227'o'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object pnlImprimir: TPanel
    ...
    object chkNovaPagina: TCheckBox
      Tag = 30
      Left = 4
      Top = 84
      Width = 221
      Height = 17
      Caption = 'Iniciar nova p'#225'gina para cada tabela'
      TabOrder = 3
    end
    ...
    object chkTodosTabela: TCheckBox
      Tag = 30
      Left = 264
      Top = 56
      Width = 97
      ...
      Caption = 'TODOS'
      TabOrder = 2
      OnClick = chkTodosTabelaClick
    end
  end
  object zqryTabela: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT tab_codigo, tab_descricao'
      'FROM inspecao_tabela_padrao'
      'ORDER BY tab_codigo')
    Params = <>
    Left = 64
    Top = 215
  ...
  object cdsTabela: TClientDataSet
    ...
    Left = 144
    Top = 215
    object cdsTabelatab_codigo: TIntegerField
      FieldName = 'tab_codigo'
      Required = True
    end
    object cdsTabelatab_descricao: TWideStringField
      FieldName = 'tab_descricao'
      Size = 30
    end
  end
  ...
  object frxDBDSTabelaPadrao: TfrxDBDataset
    UserName = 'frxDBDSTabelaPadrao'
    CloseDataSource = False
    FieldAliases.Strings = (
      'tab_codigo=tab_codigo'
      'tab_codigo_tabela=tab_codigo_tabela'
      'tab_cota=tab_cota'
      'tab_especificacao=tab_especificacao'
      'tab_tolerancia_mais=tab_tolerancia_mais'
      'tab_tolerancia_menos=tab_tolerancia_menos'
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT C.tab_codigo, tab_codigo_tabela, tab_cota, tab_especifica' +
        'cao, tab_tolerancia_mais, '
      '       tab_tolerancia_menos, tab_unidade, T.tab_descricao'
      'FROM inspecao_tabela_padrao_cotas C'
      
        'INNER JOIN inspecao_tabela_padrao T ON T.tab_codigo = tab_codigo' +
        '_tabela')
    Params = <>
    Left = 360
    Top = 216
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 440
    Top = 216
    object cdsImprimirtab_codigo: TIntegerField
      FieldName = 'tab_codigo'
      Required = True
    end
    object cdsImprimirtab_codigo_tabela: TIntegerField
      FieldName = 'tab_codigo_tabela'
    end
    object cdsImprimirtab_cota: TWideStringField
      FieldName = 'tab_cota'
    end
    object cdsImprimirtab_especificacao: TFloatField
      FieldName = 'tab_especificacao'
    end
    object cdsImprimirtab_tolerancia_mais: TFloatField
      FieldName = 'tab_tolerancia_mais'
    end
    object cdsImprimirtab_tolerancia_menos: TFloatField
      FieldName = 'tab_tolerancia_menos'
    end
    object cdsImprimirtab_unidade: TWideStringField
      FieldName = 'tab_unidade'
      Size = 10
    end
    object cdsImprimirtab_descricao: TWideStringField
      FieldName = 'tab_descricao'
      Size = 30
    end
  end
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43424.711582384260000000
    ...
    ScriptText.Strings = (
      ...
      'begin'
        ...
        '   GroupHeader1.StartNewPage:= <NovaPagina> = '#39'Sim'#39';            ' +
        '                                          '
      'end;'
      ''
      'begin'
    ...
    Datasets = <
      item
        DataSet = frxDBDSTabelaPadrao
        DataSetName = 'frxDBDSTabelaPadrao'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Titulo: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'TABELA PADR'#195'O DE INSPE'#199#195'O')
          ParentFont = False
        end
      ...
      object Detalhe: TfrxMasterData
        ...
        object frxControleDATA: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSTabelaPadrao."tab_cota"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo10: TfrxMemoView
          Left = 150.771653540000000000
          Width = 139.842553860000000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'tab_especificacao'
          DataSet = frxDBDSTabelaPadrao
          DataSetName = 'frxDBDSTabelaPadrao'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSTabelaPadrao."tab_especificacao"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSTabelaPadrao."tab_tolerancia_mais"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo5: TfrxMemoView
          Left = 429.866420000000000000
          Width = 140.976377952755900000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'tab_tolerancia_menos'
          DataSet = frxDBDSTabelaPadrao
          DataSetName = 'frxDBDSTabelaPadrao'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSTabelaPadrao."tab_tolerancia_menos"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo8: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSTabelaPadrao."tab_unidade"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Condition = 'frxDBDSTabelaPadrao."tab_descricao"'
        KeepTogether = True
        ...
        object Memo3: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            'Tabela: [frxDBDSTabelaPadrao."tab_descricao"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object zqryCotas: TZQuery
    Connection = dm.Conexao
    Params = <>
    Left = 64
    Top = 311
  end
  object dspCotas: TDataSetProvider
    DataSet = zqryCotas
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 104
  ...
  object cdsCotas: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspCotas'
    Left = 144
    Top = 311
  end
