object FormPesqManutencao: TFormPesqManutencao
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Pesquisa de Manuten'#231#227'o Preventiva'
  ClientHeight = 465
  ClientWidth = 580
  Color = clBtnFace
  ...
  object pnl1: TPanel
    ...
    object btnSelecionar: TBitBtn
      ...
      Width = 73
      Height = 70
      Hint = 'Clique para selecionar o item de Infraestrutura'
      Align = alLeft
      Caption = '&Selecionar'
      DoubleBuffered = True
      Font.Charset = DEFAULT_CHARSET
  ...
  object zqryManutencao: TZQuery
    ...
    SQL.Strings = (
        ...
        'oque_man, quan_man, quem_man, proc_man, efic_man, TC.valo_com as' +
        ' Quando '
      'FROM manutencao'
      
        'INNER JOIN tabela_combos TC ON TC.tipo_com = 19 and TC.codi_com ' +
        '= CAST(quan_man AS Integer)')
    Params = <>
    Left = 136
    Top = 160
  end
  ...
  object cdsManutencao: TClientDataSet
    ...
    object cdsManutencaoanom_man: TWideMemoField
      FieldName = 'anom_man'
      BlobType = ftWideMemo
    end
    object cdsManutencaocomo_man: TWideMemoField
      FieldName = 'como_man'
      BlobType = ftWideMemo
    end
    ...
    object cdsManutencaoquando: TWideStringField
      FieldName = 'quando'
      ReadOnly = True
      Size = 50
    end
