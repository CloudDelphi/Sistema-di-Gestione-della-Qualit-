object FormRelatorioGeral: TFormRelatorioGeral
  Left = 0
  Top = 0
  ...
  object pnl8: TPanel
    ...
    object btnVideo: TBitBtn
      ...
      Width = 73
      Height = 70
      Hint = 'Clique para visualizar o relat'#243'rio em tela'
      Align = alLeft
      Caption = '&V'#237'deo'
      DoubleBuffered = True
      Font.Charset = DEFAULT_CHARSET
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43019.630619224510000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo12: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            ' Tipo Manuten'#231#227'o: [frxDBRelManutencao."TipoManut"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object zqryManutencao: TZQuery
    ...
    SQL.Strings = (
        ...
        '       M.man_horainicio, M.man_horafim, M.man_equipamento, P.nom' +
        'e_pro,'
      '       I.desc_inf, man_identificacao, TC.valo_com as TipoManut'
      'FROM manut M'
      ...
      'INNER JOIN manut_modelo MM ON MM.man_codigo = M.man_modelo'
        ...
        'INNER JOIN tabela_combos TC ON TC.tipo_com = 36 AND TC.codi_com ' +
        '= M.man_tipo')
    Params = <>
    Left = 24
    Top = 125
  ...
  object cdsManutencao: TClientDataSet
    ...
    Left = 88
    Top = 125
    object cdsManutencaoman_codigo: TIntegerField
      FieldName = 'man_codigo'
      Required = True
    end
    object cdsManutencaoman_modelo: TIntegerField
      FieldName = 'man_modelo'
    end
    object cdsManutencaoman_processo: TIntegerField
      FieldName = 'man_processo'
    end
    object cdsManutencaoman_datainicio: TDateTimeField
      FieldName = 'man_datainicio'
    end
    object cdsManutencaoman_datafim: TDateTimeField
      FieldName = 'man_datafim'
    end
    object cdsManutencaoman_horainicio: TWideStringField
      FieldName = 'man_horainicio'
      Size = 5
    end
    object cdsManutencaoman_horafim: TWideStringField
      FieldName = 'man_horafim'
      Size = 5
    end
    object cdsManutencaoman_equipamento: TIntegerField
      FieldName = 'man_equipamento'
    end
    object cdsManutencaonome_pro: TWideStringField
      FieldName = 'nome_pro'
      Size = 45
    end
    object cdsManutencaodesc_inf: TWideStringField
      FieldName = 'desc_inf'
      Size = 100
    end
    object cdsManutencaoman_identificacao: TWideStringField
      FieldName = 'man_identificacao'
      Size = 30
    end
    object cdsManutencaotipomanut: TWideStringField
      FieldName = 'tipomanut'
      ReadOnly = True
      Size = 50
    end
  ...
  object frxDBRelManutencao: TfrxDBDataset
    UserName = 'frxDBRelManutencao'
