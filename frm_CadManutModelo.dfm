object FormCadManutModelo: TFormCadManutModelo
  Left = 0
  Top = 0
  ...
  object pgcManut: TPageControl
    ...
    object tsCadastro: TTabSheet
      ...
      object lbl15: TLabel
        ...
        Width = 125
        Height = 13
        Caption = 'Orienta'#231#245'es/Observa'#231#245'es'
        Color = clBackground
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
      ...
      object mmoObs: TMemo
        ...
        Width = 760
        Height = 285
        Hint = 'Observa'#231#245'es ou orienta'#231#245'es da manuten'#231#227'o'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Tahoma'
      ...
      object dbgItens: TDBGrid
        ...
        Columns = <
          item
            ...
            Title.Caption = 'Item de Manuten'#231#227'o'
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT M.man_codigo, M.man_identificacao, M.man_descricao, M.man' +
        '_obs,'
      'MI.ite_descricao'
      'FROM manut_modelo M'
      'INNER JOIN manut_modelo_itens MI ON MI.man_codigo = M.man_codigo'
  ...
  object cdsImprimir: TClientDataSet
    ...
    object cdsImprimirman_obs: TWideMemoField
      FieldName = 'man_obs'
      BlobType = ftWideMemo
    end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42969.429617997700000000
    ...
    Datasets = <
      item
        DataSet = frxDBManutModelo
        DataSetName = 'frxDBManutModelo'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'MODELO DE MANUTEN'#199#195'O PREVENTIVA')
          ParentFont = False
        end
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo10: TfrxMemoView
          ...
          Memo.UTF8W = (
            '[frxDBManutModelo."ite_descricao"]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 718.110700000000000000
        Condition = 'frxDBManutModelo."man_codigo"'
        KeepTogether = True
        StartNewPage = True
        ...
        object Memo21: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[frxDBManutModelo."man_identificacao"]')
          ParentFont = False
        end
        object Memo22: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[frxDBManutModelo."man_descricao"]')
          ParentFont = False
        end
  ...
  object frxDBManutModelo: TfrxDBDataset
    UserName = 'frxDBManutModelo'
