object FormContextoAnalise: TFormContextoAnalise
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'An'#225'lise de Contextos'
  ClientHeight = 477
  ClientWidth = 624
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctContexto: TJvgPageControl
    Left = 0
    Top = 0
    Width = 624
    Height = 405
    ...
    object tsCadastro: TTabSheet
      ...
      object mmoRequisito: TMemo
        ...
        TabOrder = 3
        OnKeyPress = mmoRequisitoKeyPress
      end
      object dblContexto: TDBLookupComboBox
        Left = 73
        Top = 26
        Width = 264
        Height = 26
        ...
        KeyField = 'con_codigo'
        ListField = 'con_nome'
        ListSource = dsContexto
        ParentFont = False
        TabOrder = 1
      end
      object dblParte: TDBLookupComboBox
        Left = 343
        Top = 26
        Width = 264
        Height = 26
    ...
    object tsPesquisa: TTabSheet
      ...
      object cbbCampo: TComboBox
        ...
        ParentFont = False
        TabOrder = 1
        Text = 'Nome do Contexto'
        Items.Strings = (
          'Nome do Contexto')
      end
      object dbgContextos: TDBGrid
        Left = 5
        Top = 64
        Width = 608
        Height = 308
        ...
        TitleFont.Style = []
        OnCellClick = dbgContextosCellClick
        OnDblClick = dbgContextosDblClick
        Columns = <
          item
            Expanded = False
            FieldName = 'ana_codigo'
          ...
          item
            Expanded = False
            FieldName = 'con_nome'
            Title.Caption = 'Nome do Contexto'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
          ...
          item
            Expanded = False
            FieldName = 'par_nome'
            Title.Caption = 'Parte Interessada'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object zqryContexto: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT con_codigo, con_nome, con_descricao'
      'FROM contextos'
      'ORDER BY con_codigo')
    Params = <>
    Left = 64
  ...
  object dspContexto: TDataSetProvider
    DataSet = zqryContexto
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 104
    Top = 215
  end
  object cdsContexto: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspContexto'
    Left = 144
    Top = 215
    object cdsContextocon_codigo: TIntegerField
      FieldName = 'con_codigo'
      Required = True
    end
    object cdsContextocon_nome: TWideStringField
      FieldName = 'con_nome'
      Size = 200
    end
    object cdsContextocon_descricao: TWideMemoField
      FieldName = 'con_descricao'
      BlobType = ftWideMemo
    end
  end
  object dsContexto: TDataSource
    DataSet = cdsContexto
    Left = 184
    Top = 215
  end
  ...
  object frxDBDSAnaliseContextos: TfrxDBDataset
    UserName = 'frxDBDSAnaliseContextos'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ana_codigo=ana_codigo'
      'ana_contexto=ana_contexto'
      'ana_parte=ana_parte'
      'ana_requisito=ana_requisito'
      'ana_monitoramento=ana_monitoramento'
      'con_nome=con_nome'
      'par_nome=par_nome')
    DataSet = cdsImprimir
    BCDToCurrency = False
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT ana_codigo, ana_contexto, ana_parte, ana_requisito, ana_m' +
        'onitoramento,'
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 440
    Top = 216
    object cdsImprimirana_codigo: TIntegerField
      FieldName = 'ana_codigo'
      Required = True
    end
    object cdsImprimirana_contexto: TIntegerField
      FieldName = 'ana_contexto'
    end
    object cdsImprimirana_parte: TIntegerField
      FieldName = 'ana_parte'
    end
    object cdsImprimirana_requisito: TWideMemoField
      FieldName = 'ana_requisito'
      BlobType = ftWideMemo
    end
    object cdsImprimirana_monitoramento: TWideMemoField
      FieldName = 'ana_monitoramento'
      BlobType = ftWideMemo
    end
    object cdsImprimircon_nome: TWideStringField
      FieldName = 'con_nome'
      Size = 200
    end
    object cdsImprimirpar_nome: TWideStringField
      FieldName = 'par_nome'
      Size = 200
    end
  end
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43242.452803368100000000
  ...
  object cdsAnalise: TClientDataSet
    ...
    Left = 144
    Top = 319
    object cdsAnaliseana_codigo: TIntegerField
      FieldName = 'ana_codigo'
      Required = True
    end
    object cdsAnaliseana_contexto: TIntegerField
      FieldName = 'ana_contexto'
    end
    object cdsAnaliseana_parte: TIntegerField
      FieldName = 'ana_parte'
    end
    object cdsAnaliseana_requisito: TWideMemoField
      FieldName = 'ana_requisito'
      BlobType = ftWideMemo
    end
    object cdsAnaliseana_monitoramento: TWideMemoField
      FieldName = 'ana_monitoramento'
      BlobType = ftWideMemo
    end
    object cdsAnalisecon_nome: TWideStringField
      FieldName = 'con_nome'
      Size = 200
    end
    object cdsAnalisepar_nome: TWideStringField
      FieldName = 'par_nome'
      Size = 200
    end
  end
  ...
  object zqryPartes: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT par_codigo, par_nome, par_descricao'
      'FROM partes'
      'ORDER BY par_codigo')
    Params = <>
    Left = 64
  ...
  object dspPartes: TDataSetProvider
    DataSet = zqryPartes
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 104
  ...
  object cdsPartes: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspPartes'
    Left = 144
    Top = 167
    object cdsPartespar_codigo: TIntegerField
      FieldName = 'par_codigo'
      Required = True
    end
    object cdsPartespar_nome: TWideStringField
      FieldName = 'par_nome'
      Size = 200
    end
    object cdsPartespar_descricao: TWideMemoField
