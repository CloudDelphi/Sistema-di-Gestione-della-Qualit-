object FormCadPartesInteressadas: TFormCadPartesInteressadas
  Left = 0
  Top = 0
  ...
  object pctContexto: TJvgPageControl
    ...
    object tsCadastro: TTabSheet
      ...
      object lbl4: TLabel
        ...
        Width = 132
        Height = 13
        Caption = 'Nome da Parte Interessada'
      end
      object lbl16: TLabel
        Left = 14
        Top = 107
        Width = 151
        Height = 13
        Caption = 'Descri'#231#227'o da Parte Interessada'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object mmoDescParte: TMemo
        ...
        TabOrder = 2
        OnExit = mmoDescParteExit
        OnKeyPress = mmoDescParteKeyPress
      end
    end
    object tsPesquisa: TTabSheet
      ...
      object cbbCampo: TComboBox
        ...
        ParentFont = False
        TabOrder = 1
        Text = 'Nome da Parte Interessada'
        Items.Strings = (
      ...
      object dbgContextos: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'par_nome'
            Title.Caption = 'Nome da Parte Interessada'
            Title.Font.Charset = DEFAULT_CHARSET
            Title.Font.Color = clWindowText
            Title.Font.Height = -11
            Title.Font.Name = 'Tahoma'
  ...
  object frxDBDSPartes: TfrxDBDataset
    UserName = 'frxDBDSPartes'
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 440
    Top = 216
    object cdsImprimirpar_codigo: TIntegerField
      FieldName = 'par_codigo'
      Required = True
    end
    ...
    object cdsImprimirpar_descricao: TWideMemoField
      FieldName = 'par_descricao'
      BlobType = ftWideMemo
    end
  end
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42408.470557453700000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSPartes
        DataSetName = 'frxDBDSPartes'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Titulo: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'LISTAGEM DE PARTES INTERESSADAS')
          ParentFont = False
        end
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo10: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8W = (
            '[frxDBDSPartes."par_nome"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo1: TfrxMemoView
          Left = 20.409448820000000000
        ...
        object Memo2: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Descri'#231#227'o da Parte Interessada')
          ParentFont = False
          VAlign = vaBottom
        end
