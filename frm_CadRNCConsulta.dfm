object FormCadRNCConsulta: TFormCadRNCConsulta
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Consulta de RNC'
  ClientHeight = 654
  ClientWidth = 924
  Color = clBtnFace
  ...
  object AdvChartView3DMotivos: TAdvChartView3D
    Left = 0
    Top = 329
    Width = 482
    Height = 253
    ...
    Title.Font.Style = []
    Title.Text = 'Gr'#225'fico de Motivos de PMC'
  ...
  object edtNumRNC: TEdit
    ...
    ParentFont = False
    TabOrder = 3
    OnChange = edtNumRNCChange
  end
  object AdvChartView3DStatus: TAdvChartView3D
    Left = 448
    Top = 329
    Width = 473
    Height = 253
    ...
    Title.Font.Name = 'Tahoma'
    Title.Font.Style = []
    Title.Text = 'Gr'#225'fico de Status de PMC'
    Version = '1.0.2.2 FEBRUARY, 2015'
  end
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'CL.cli_nome, rnc_fornecedor, F.forn_nome, rnc_consumidor, rnc_nc' +
        'onformidade, '
  ...
  object cdsImprimir: TClientDataSet
    ...
    object cdsImprimircli_nome2: TWideStringField
      FieldName = 'cli_nome'
      Size = 200
    end
    ...
    object cdsImprimirforn_nome2: TWideStringField
      FieldName = 'forn_nome'
      Size = 80
    end
  ...
  object zqryRNC: TZQuery
    ...
    SQL.Strings = (
        ...
        '       rnc_processo, rnc_setor, rnc_origem, rnc_cliente, rnc_for' +
        'necedor, '
      
        '       rnc_consumidor, rnc_nconformidade, rnc_procede, rnc_respo' +
        'nsavel, '
      
        '       rnc_departamento, rnc_relacionamento, rnc_representante, ' +
        'rnc_status, rnc_ordemprod'
      '  FROM rnc'
  ...
  object cdsRNC: TClientDataSet
    ...
    Left = 208
    Top = 216
    object cdsRNCrnc_codigo: TIntegerField
      FieldName = 'rnc_codigo'
      Required = True
    end
    object cdsRNCrnc_identificacao: TWideStringField
      FieldName = 'rnc_identificacao'
      Required = True
      Size = 7
    end
    object cdsRNCrnc_data: TDateTimeField
      FieldName = 'rnc_data'
    end
    object cdsRNCrnc_emitido: TIntegerField
      FieldName = 'rnc_emitido'
    end
    object cdsRNCrnc_motivo: TIntegerField
      FieldName = 'rnc_motivo'
    end
    object cdsRNCrnc_processo: TIntegerField
      FieldName = 'rnc_processo'
    end
    object cdsRNCrnc_setor: TWideStringField
      FieldName = 'rnc_setor'
      Size = 25
    end
    object cdsRNCrnc_origem: TIntegerField
      FieldName = 'rnc_origem'
    end
    object cdsRNCrnc_cliente: TIntegerField
      FieldName = 'rnc_cliente'
    end
    object cdsRNCrnc_fornecedor: TIntegerField
      FieldName = 'rnc_fornecedor'
    end
    object cdsRNCrnc_consumidor: TWideStringField
      FieldName = 'rnc_consumidor'
      Size = 60
    end
    object cdsRNCrnc_nconformidade: TWideMemoField
      FieldName = 'rnc_nconformidade'
      BlobType = ftWideMemo
    end
    object cdsRNCrnc_procede: TIntegerField
      FieldName = 'rnc_procede'
    end
    object cdsRNCrnc_responsavel: TIntegerField
      FieldName = 'rnc_responsavel'
    end
    object cdsRNCrnc_departamento: TWideStringField
      FieldName = 'rnc_departamento'
      Size = 25
    end
    object cdsRNCrnc_relacionamento: TIntegerField
      FieldName = 'rnc_relacionamento'
    end
    object cdsRNCrnc_representante: TWideStringField
      FieldName = 'rnc_representante'
      Size = 25
    end
    object cdsRNCrnc_status: TIntegerField
      FieldName = 'rnc_status'
    end
    object cdsRNCDescMotivo: TStringField
      FieldKind = fkLookup
      FieldName = 'DescMotivo'
      LookupDataSet = cdsMotivo
      LookupKeyFields = 'codi_com'
      LookupResultField = 'valo_com'
      KeyFields = 'rnc_motivo'
      Size = 80
      Lookup = True
    end
    object cdsRNCDescResp: TStringField
      FieldKind = fkLookup
      FieldName = 'DescResp'
      LookupDataSet = cdsResponsavel
      LookupKeyFields = 'codi_col'
      LookupResultField = 'nome_col'
      KeyFields = 'rnc_responsavel'
      Size = 80
      Lookup = True
    end
    object cdsRNCDescStatus: TStringField
      FieldKind = fkLookup
      FieldName = 'DescStatus'
      LookupDataSet = cdsStatus
      LookupKeyFields = 'codi_com'
      LookupResultField = 'valo_com'
      KeyFields = 'rnc_status'
      Size = 50
      Lookup = True
    end
    object cdsRNCrnc_ordemprod: TWideStringField
      FieldName = 'rnc_ordemprod'
      Size = 10
    end
  end
  ...
  object zqryGrafico: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT rnc_motivo, valo_com, COUNT(*) as Qtd'
      'FROM rnc'
  ...
  object cdsGrafico: TClientDataSet
    ...
    object cdsGraficornc_motivo: TIntegerField
      FieldName = 'rnc_motivo'
    end
  end
  ...
  object cdsGraficoStatus: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspGraficoStatus'
    Left = 751
    Top = 408
    ...
    object cdsGraficoStatusrnc_status: TIntegerField
      FieldName = 'rnc_status'
    end
  end
  object dspGraficoStatus: TDataSetProvider
    DataSet = zqryGraficoStatus
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 700
    Top = 408
  end
  object zqryGraficoStatus: TZQuery
    Connection = dm.Conexao
    SQL.Strings = (
      'SELECT rnc_status, valo_com, COUNT(*) as Qtd'
      'FROM rnc'
