object FormCadAmostragem: TFormCadAmostragem
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Amostragens'
  ClientHeight = 633
  ClientWidth = 608
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object pctAmostragem: TJvgPageControl
    Left = 0
    Top = 0
    Width = 608
    Height = 561
    ...
    object tsPesquisa: TTabSheet
      ...
      object dbgAmostragem: TDBGrid
        Left = 5
        Top = 62
        Width = 591
        Height = 468
        Hint = 'Selecione o registro para alterar'
        DataSource = dsAmostragem
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
        Font.Name = 'Tahoma'
        ...
        TitleFont.Style = []
        OnCellClick = dbgAmostragemCellClick
        OnDblClick = dbgAmostragemDblClick
        Columns = <
          item
            Expanded = False
            FieldName = 'amo_tipo_tabela'
  ...
  object pnlImprimir: TPanel
    ...
    object dblTabela: TDBLookupComboBox
      ...
      Font.Name = 'Tahoma'
      Font.Style = []
      KeyField = 'amo_tipo_tabela'
      ListField = 'amo_tipo_tabela'
      ListSource = dsTabelas
      ParentFont = False
      TabOrder = 1
    end
    object chkTodosTabelas: TCheckBox
      Tag = 30
      Left = 287
      Top = 68
      Width = 61
      ...
      State = cbChecked
      TabOrder = 2
      OnClick = chkTodosTabelasClick
    end
  end
  object zqryAmostragem: TZQuery
  ...
  object dspAmostragem: TDataSetProvider
    DataSet = zqryAmostragem
    Options = [poAutoRefresh, poAllowCommandText]
    UpdateMode = upWhereKeyOnly
    Left = 104
    Top = 215
  end
  object cdsAmostragem: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspAmostragem'
    Left = 144
    Top = 215
  end
  object dsAmostragem: TDataSource
    DataSet = cdsAmostragem
    Left = 184
    Top = 215
  end
  ...
  object frxDBDSAmostragem: TfrxDBDataset
    UserName = 'frxDBDSAmostragem'
    CloseDataSource = False
    FieldAliases.Strings = (
      'amo_codigo=amo_codigo'
      'amo_tipo_tabela=amo_tipo_tabela'
      'amo_tamanho_lote=amo_tamanho_lote'
      'amo_amostragem=amo_amostragem'
      'amo_aprova=amo_aprova'
      'amo_reprova=amo_reprova')
    DataSet = cdsImprimir
    BCDToCurrency = False
    Left = 304
    Top = 216
  ...
  object zqryImprimir: TZQuery
    ...
    SQL.Strings = (
        ...
        'SELECT amo_codigo, amo_tipo_tabela, amo_tamanho_lote, amo_amostr' +
        'agem,'
      'amo_aprova, amo_reprova'
      'FROM inspecao_amostragem')
    Params = <>
    Left = 360
    Top = 216
  end
  ...
  object cdsImprimir: TClientDataSet
    ...
    Left = 440
    Top = 216
    object cdsImprimiramo_codigo: TIntegerField
      FieldName = 'amo_codigo'
      Required = True
    end
    object cdsImprimiramo_tipo_tabela: TWideStringField
      FieldName = 'amo_tipo_tabela'
      Size = 10
    end
    object cdsImprimiramo_tamanho_lote: TWideStringField
      FieldName = 'amo_tamanho_lote'
    end
    object cdsImprimiramo_amostragem: TIntegerField
      FieldName = 'amo_amostragem'
    end
    object cdsImprimiramo_aprova: TIntegerField
      FieldName = 'amo_aprova'
    end
    object cdsImprimiramo_reprova: TIntegerField
      FieldName = 'amo_reprova'
    end
  end
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43348.599660289350000000
    ...
    Datasets = <
      item
        DataSet = frxDBDSAmostragem
        DataSetName = 'frxDBDSAmostragem'
      end>
    Variables = <
      item
        Name = ' New Category1'
    ...
    object Page1: TfrxReportPage
      ...
      object Titulo: TfrxReportTitle
        ...
        object Memo4: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'AMOSTRAGENS DE INSPE'#199#195'O')
          ParentFont = False
        end
      ...
      object Detalhe: TfrxMasterData
        ...
        object Memo11: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSAmostragem."amo_tamanho_lote"]')
          ParentFont = False
        end
        object Memo3: TfrxMemoView
          Left = 271.165430000000000000
          Width = 98.267780000000000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'amo_amostragem'
          DataSet = frxDBDSAmostragem
          DataSetName = 'frxDBDSAmostragem'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSAmostragem."amo_amostragem"]')
          ParentFont = False
        end
        object Memo7: TfrxMemoView
          Left = 369.433210000000000000
          Width = 98.267780000000000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'amo_aprova'
          DataSet = frxDBDSAmostragem
          DataSetName = 'frxDBDSAmostragem'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            '[frxDBDSAmostragem."amo_aprova"]')
          ParentFont = False
        end
        object Memo10: TfrxMemoView
          Left = 467.700990000000000000
          Width = 98.267780000000000000
          Height = 18.897650000000000000
          ShowHint = False
          DataField = 'amo_reprova'
          DataSet = frxDBDSAmostragem
          DataSetName = 'frxDBDSAmostragem'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
      ...
      object GroupHeader2: TfrxGroupHeader
        Height = 45.543302200000000000
        Top = 158.740260000000000000
        Width = 718.110700000000000000
        Condition = 'frxDBDSAmostragem."amo_tipo_tabela"'
        ...
        object Memo9: TfrxMemoView
          Left = 271.165354330000000000
          Top = 26.456692909999990000
          Width = 98.645527720000000000
          Height = 18.897650000000000000
          ShowHint = False
          Color = clScrollBar
          DisplayFormat.DecimalSeparator = ','
        ...
        object Memo2: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            '[frxDBDSAmostragem."amo_tipo_tabela"]')
          ParentFont = False
        end
      end
    end
