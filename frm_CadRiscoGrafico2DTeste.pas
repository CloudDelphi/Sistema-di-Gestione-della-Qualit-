unit frm_CadRiscoGrafico2DTeste;
...
type
  TFormRiscoGrafico2DTeste = class(TForm)
    zqryAnalise: TZQuery;
    ...
    cdsValorIndicadoressequ_vin: TLargeintField;
...
var
  FormRiscoGrafico2DTeste: TFormRiscoGrafico2DTeste;
...
procedure TFormRiscoGrafico2DTeste.AtualizarDados;
begin
...
procedure TFormRiscoGrafico2DTeste.btn1Click(Sender: TObject);
begin
...
procedure TFormRiscoGrafico2DTeste.btnPadraoClick(Sender: TObject);
begin
   Inicializar();
end;

procedure TFormRiscoGrafico2DTeste.btn4Click(Sender: TObject);
var
   fn, ext: string;
   imgt: TImageType;
begin
...
procedure TFormRiscoGrafico2DTeste.btnCoresClick(Sender: TObject);
var
   I: Integer;
begin
...
procedure TFormRiscoGrafico2DTeste.btnSairClick(Sender: TObject);
begin
   Self.Close;
end;

procedure TFormRiscoGrafico2DTeste.cdsValorIndicadoresCalcFields(DataSet: TDataSet);
begin
...
procedure TFormRiscoGrafico2DTeste.FormShow(Sender: TObject);
begin
   AtualizarDados();
   Inicializar();
end;

procedure TFormRiscoGrafico2DTeste.Inicializar;
var
